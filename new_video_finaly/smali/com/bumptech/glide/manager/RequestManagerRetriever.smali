...
# static fields
.field private static final f:Lcom/bumptech/glide/manager/RequestManagerRetriever$RequestManagerFactory;
...
.method private b(Landroid/content/Context;Landroid/app/FragmentManager;Landroid/app/Fragment;)Lcom/bumptech/glide/RequestManager;
    .locals 3

    .line 1
    invoke-virtual {p0, p2, p3}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->g(Landroid/app/FragmentManager;Landroid/app/Fragment;)Lcom/bumptech/glide/manager/RequestManagerFragment;

    move-result-object p2

    .line 2
    invoke-virtual {p2}, Lcom/bumptech/glide/manager/RequestManagerFragment;->d()Lcom/bumptech/glide/RequestManager;
    ...
    invoke-virtual {p2}, Lcom/bumptech/glide/manager/RequestManagerFragment;->e()Lcom/bumptech/glide/manager/RequestManagerTreeNode;
    ...
    .line 7
    invoke-virtual {p2, p3}, Lcom/bumptech/glide/manager/RequestManagerFragment;->i(Lcom/bumptech/glide/RequestManager;)V

    :cond_0
    return-object p3
.end method

.method private f(Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
    .locals 4
...
.method private i(Landroid/content/Context;Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)Lcom/bumptech/glide/RequestManager;
    .locals 3

    .line 1
    invoke-virtual {p0, p2, p3}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->h(Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;

    move-result-object p2

    .line 2
    invoke-virtual {p2}, Lcom/bumptech/glide/manager/SupportRequestManagerFragment;->Y()Lcom/bumptech/glide/RequestManager;
    ...
    .line 5
    invoke-virtual {p2}, Lcom/bumptech/glide/manager/SupportRequestManagerFragment;->W()Lcom/bumptech/glide/manager/ActivityFragmentLifecycle;

    move-result-object v1

    invoke-virtual {p2}, Lcom/bumptech/glide/manager/SupportRequestManagerFragment;->Z()Lcom/bumptech/glide/manager/RequestManagerTreeNode;
    ...
    .line 7
    invoke-virtual {p2, p3}, Lcom/bumptech/glide/manager/SupportRequestManagerFragment;->d0(Lcom/bumptech/glide/RequestManager;)V
...
# virtual methods
.method public c(Landroid/app/Activity;)Lcom/bumptech/glide/RequestManager;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->d(Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
    ...
    .line 5
    invoke-direct {p0, p1, v0, v1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->b(Landroid/content/Context;Landroid/app/FragmentManager;Landroid/app/Fragment;)Lcom/bumptech/glide/RequestManager;
...
.method public d(Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->c(Landroid/app/Activity;)Lcom/bumptech/glide/RequestManager;
    ...
    .line 8
    :cond_2
    invoke-direct {p0, p1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->f(Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
...
.method public e(Landroidx/fragment/app/FragmentActivity;)Lcom/bumptech/glide/RequestManager;
    .locals 2
    ...
    .line 5
    invoke-direct {p0, p1, v0, v1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->i(Landroid/content/Context;Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)Lcom/bumptech/glide/RequestManager;
...
.method h(Landroidx/fragment/app/FragmentManager;Landroidx/fragment/app/Fragment;)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;
    .locals 2
    ...
    .line 4
    invoke-virtual {v1, p2}, Lcom/bumptech/glide/manager/SupportRequestManagerFragment;->c0(Landroidx/fragment/app/Fragment;)V
