...
.method public static a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    const-string/jumbo p0, "zmob_cache"
    ...
    .line 25
    :try_start_5
    invoke-static {p3, v4}, Lcom/da/config/service/AppRecommendHelper;->b(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    ...
    const-string p1, "AppRecommendHelper"
    ...
    const-string v1, "Download incomplete bytesCopied="
    ...
    :goto_4
    :try_start_6
    invoke-static {v4}, Lcom/da/config/util/IOUtil;->b(Ljava/io/OutputStream;)V
    :try_end_6
    ...
    .line 31
    :goto_6
    invoke-static {p3}, Lcom/da/config/util/IOUtil;->a(Ljava/io/InputStream;)V
...
.method public static c(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    .line 1
    new-instance v0, Lcom/da/config/service/b;

    invoke-direct {v0, p0}, Lcom/da/config/service/b;-><init>(Landroid/content/Context;)V
...
.method static synthetic g(Landroid/content/Context;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/da/config/service/AppRecommendHelper;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "tracklink"
...
.method static synthetic h(Landroid/content/Context;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/da/config/service/AppRecommendHelper;->j(Landroid/content/Context;)V
...
.method private static i(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "tracklink"
...
.method private static j(Landroid/content/Context;)V
    ...
    .line 5
    sget-boolean v7, Lcom/da/config/AdManagerHelper;->g:Z
    ...
    .line 7
    invoke-static {p0}, Lcom/da/config/util/AdvertisingIdUtil;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 11
    invoke-static {v0, v4}, Lcom/da/config/util/Transport;->b(Ljava/lang/String;Landroid/os/Bundle;)[B
    ...
    .line 12
    invoke-static {v0}, Lcom/da/config/util/TestSecConverter;->a([B)Ljava/lang/String;
    ...
    .line 14
    invoke-static {p0, v4}, Lcom/da/config/service/AppRecommendHelper;->i(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 18
    invoke-static {p0, v0}, Lcom/da/config/service/AppRecommendHelper;->k(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
...
.method private static k(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v1, "AppRecommendHelper"
...
.method public static l(Landroid/content/Context;)V
    ...
    const-string v4, "recommend_data.json"
    ...
    .line 10
    :cond_0
    new-instance p0, Lcom/da/config/service/a;

    invoke-direct {p0, v0}, Lcom/da/config/service/a;-><init>(Landroid/content/Context;)V
