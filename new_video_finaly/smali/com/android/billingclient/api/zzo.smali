...
.field private final b:Lcom/android/billingclient/api/zzn;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/billingclient/api/PurchasesUpdatedListener;Lcom/android/billingclient/api/AlternativeBillingListener;Lcom/android/billingclient/api/zzbh;)V
    ...
    iput-object p1, p0, Lcom/android/billingclient/api/zzo;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/billingclient/api/zzo;->b:Lcom/android/billingclient/api/zzn;
...
.method static bridge synthetic a(Lcom/android/billingclient/api/zzo;)Lcom/android/billingclient/api/zzn;
    .locals 0

    iget-object p0, p0, Lcom/android/billingclient/api/zzo;->b:Lcom/android/billingclient/api/zzn;
...
# virtual methods
.method final b()Lcom/android/billingclient/api/zzbf;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    .line 1
    iget-object v0, p0, Lcom/android/billingclient/api/zzo;->b:Lcom/android/billingclient/api/zzn;

    invoke-static {v0}, Lcom/android/billingclient/api/zzn;->a(Lcom/android/billingclient/api/zzn;)Lcom/android/billingclient/api/zzbf;
...
.method final d()V
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/zzo;->a:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lcom/android/billingclient/api/zzn;->d(Landroid/content/Context;)V
...
.method final e()V
    ...
    iget-object v1, p0, Lcom/android/billingclient/api/zzo;->b:Lcom/android/billingclient/api/zzn;

    iget-object v2, p0, Lcom/android/billingclient/api/zzo;->a:Landroid/content/Context;

    .line 3
    invoke-virtual {v1, v2, v0}, Lcom/android/billingclient/api/zzn;->c(Landroid/content/Context;Landroid/content/IntentFilter;)V
