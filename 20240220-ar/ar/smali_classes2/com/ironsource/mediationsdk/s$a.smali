...
.method public run()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/ironsource/q4;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->k(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/w7;
    ...
    invoke-virtual {v1, v2}, Lcom/ironsource/w7;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/ironsource/mediationsdk/p;->b(Landroid/content/Context;Ljava/lang/String;Lcom/ironsource/mediationsdk/p$c;)Lcom/ironsource/mediationsdk/utils/c;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/mediationsdk/utils/c;)Lcom/ironsource/mediationsdk/utils/c;

    iget-object v1, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->m(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/mediationsdk/utils/c;
    ...
    invoke-virtual {v1, v2}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/utils/c;)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/j0;->e()Lcom/ironsource/o0;

    move-result-object v1

    if-eqz v1, :cond_2

    sget-object v2, Lcom/ironsource/j3;->a:Lcom/ironsource/j3;

    invoke-virtual {v1}, Lcom/ironsource/o0;->e()Z

    move-result v3

    invoke-virtual {v2, v3}, Lcom/ironsource/j3;->c(Z)V

    invoke-virtual {v1}, Lcom/ironsource/o0;->d()Z

    move-result v3

    invoke-virtual {v2, v3}, Lcom/ironsource/j3;->a(Z)V

    invoke-virtual {v1}, Lcom/ironsource/o0;->g()I

    move-result v3

    invoke-virtual {v2, v3}, Lcom/ironsource/j3;->a(I)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/o0;->f()Z
    ...
    invoke-static {v3}, Lcom/ironsource/mediationsdk/s;->m(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/mediationsdk/utils/c;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Lcom/ironsource/mediationsdk/s;->a(Landroid/content/Context;Lcom/ironsource/mediationsdk/utils/c;)V
    ...
    invoke-direct {v1}, Lcom/ironsource/ib;-><init>()V

    invoke-static {v0, v1}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/ib;)Lcom/ironsource/ib;

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->o(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ib;

    move-result-object v0

    invoke-virtual {v0}, Lcom/ironsource/ib;->a()V

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->m(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/mediationsdk/utils/c;
    ...
    invoke-virtual {v0}, Lcom/ironsource/j0;->f()Z
    ...
    check-cast v2, Lcom/ironsource/u9;
    ...
    invoke-static {v4}, Lcom/ironsource/mediationsdk/s;->m(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/mediationsdk/utils/c;
    ...
    invoke-interface {v2, v0, v3, v4}, Lcom/ironsource/u9;->a(Ljava/util/List;ZLcom/ironsource/g2;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/j0;->i()Lcom/ironsource/gb;

    move-result-object v0

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Lcom/ironsource/gb;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/ironsource/j0;->c()Lcom/ironsource/l0;

    move-result-object v0

    invoke-virtual {v0}, Lcom/ironsource/l0;->f()Z
    ...
    invoke-static {}, Lcom/ironsource/s2;->d()Lcom/ironsource/s2;
    ...
    invoke-virtual {v0}, Lcom/ironsource/l0;->b()Ljava/util/HashSet;

    move-result-object v4

    invoke-virtual {v0}, Lcom/ironsource/l0;->d()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/ironsource/l0;->e()Z

    move-result v7

    invoke-virtual {v0}, Lcom/ironsource/l0;->a()I

    move-result v9

    invoke-virtual {v0}, Lcom/ironsource/l0;->g()Z

    move-result v10

    invoke-virtual/range {v2 .. v10}, Lcom/ironsource/s2;->a(Landroid/content/Context;Ljava/util/HashSet;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;IZ)V
    ...
    check-cast v1, Lcom/ironsource/u9;

    const-string v2, "serverResponseIsNotValid"

    invoke-interface {v1, v2}, Lcom/ironsource/u9;->d(Ljava/lang/String;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/u9;->a()V
    ...
    invoke-interface {v1, v3}, Lcom/ironsource/u9;->d(Ljava/lang/String;)V
