.class public Lhl/productor/ijk/media/player/IjkMediaMeta;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    }
.end annotation
...
.field public static final IJKM_KEY_VIDEOROTATE:Ljava/lang/String; = "rotate"
...
# instance fields
.field public mAudioStream:Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
...
.field public mVideoStream:Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;

    return-void
.end method

.method public static parse(Landroid/os/Bundle;)Lhl/productor/ijk/media/player/IjkMediaMeta;
    .locals 11
    ...
    .line 1
    :cond_0
    new-instance v0, Lhl/productor/ijk/media/player/IjkMediaMeta;

    invoke-direct {v0}, Lhl/productor/ijk/media/player/IjkMediaMeta;-><init>()V

    .line 2
    iput-object p0, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    const-string p0, "format"

    .line 3
    invoke-virtual {v0, p0}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mFormat:Ljava/lang/String;

    const-string p0, "duration_us"

    .line 4
    invoke-virtual {v0, p0}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v1

    iput-wide v1, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v1, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v1, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mBitrate:J
    ...
    .line 7
    invoke-virtual {v0, v2, v1}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I

    move-result v1

    iput v1, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->rotate:I
    ...
    .line 8
    invoke-virtual {v0, v1, v2}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 9
    invoke-virtual {v0, v4, v2}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 10
    invoke-virtual {v0, v6, v2}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I

    const-string v6, "streams"

    .line 11
    invoke-virtual {v0, v6}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 13
    :cond_2
    new-instance v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v8, v2}, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 14
    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    const-string v7, "type"

    .line 15
    invoke-virtual {v8, v7}, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 17
    iget-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 21
    invoke-virtual {v8, p0}, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    int-to-long v9, v7

    iput-wide v9, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    .line 23
    invoke-virtual {v8, v7}, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne v3, v2, :cond_5

    .line 31
    iput-object v8, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mVideoStream:Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    ...
    iput v7, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    const-string v7, "channel_layout"

    .line 34
    invoke-virtual {v8, v7}, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v9

    iput-wide v9, v8, Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v5, v2, :cond_5

    .line 35
    iput-object v8, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mAudioStream:Lhl/productor/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 36
    :cond_5
    :goto_1
    iget-object v7, v0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    .line 1
    iget-wide v0, p0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    .line 2
    invoke-virtual {p0, p1}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    .line 1
    invoke-virtual {p0, p1, v0, v1}, Lhl/productor/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 1
    iget-object v0, p0, Lhl/productor/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
