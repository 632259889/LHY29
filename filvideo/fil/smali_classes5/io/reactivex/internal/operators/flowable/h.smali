...
.method public static a(Lorg/reactivestreams/c;)V
    ...
    sget-object v3, Lio/reactivex/internal/functions/Functions;->l:Lr8/g;

    invoke-direct {v1, v2, v0, v0, v3}, Lio/reactivex/internal/subscribers/LambdaSubscriber;-><init>(Lr8/g;Lr8/g;Lr8/a;Lr8/g;)V

    .line 3
    invoke-interface {p0, v1}, Lorg/reactivestreams/c;->subscribe(Lorg/reactivestreams/d;)V

    .line 4
    invoke-static {v0, v1}, Lio/reactivex/internal/util/c;->a(Ljava/util/concurrent/CountDownLatch;Lio/reactivex/disposables/b;)V

    .line 5
    iget-object p0, v0, Lio/reactivex/internal/util/d;->b:Ljava/lang/Throwable;
...
.method public static c(Lorg/reactivestreams/c;Lr8/g;Lr8/g;Lr8/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v1, Lio/reactivex/internal/functions/Functions;->l:Lr8/g;

    invoke-direct {v0, p1, p2, p3, v1}, Lio/reactivex/internal/subscribers/LambdaSubscriber;-><init>(Lr8/g;Lr8/g;Lr8/a;Lr8/g;)V

    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/h;->b(Lorg/reactivestreams/c;Lorg/reactivestreams/d;)V

    return-void
.end method

.method public static d(Lorg/reactivestreams/c;Lr8/g;Lr8/g;Lr8/a;I)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p4}, Lio/reactivex/internal/functions/Functions;->d(I)Lr8/g;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/subscribers/BoundedSubscriber;-><init>(Lr8/g;Lr8/g;Lr8/a;Lr8/g;I)V
