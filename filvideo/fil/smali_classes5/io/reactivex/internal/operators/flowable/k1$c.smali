...
.field public final i1:Lio/reactivex/h0$c;
...
# direct methods
.method public constructor <init>(Lorg/reactivestreams/d;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/h0$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->f1:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/flowable/k1$c;->g1:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/flowable/k1$c;->h1:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->i1:Lio/reactivex/h0$c;

    .line 6
    iput p8, p0, Lio/reactivex/internal/operators/flowable/k1$c;->j1:I
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->k1:Ljava/util/List;
...
.method public dispose()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->i1:Lio/reactivex/h0$c;
...
.method public m()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->k1:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->m1:Z

    if-eqz v5, :cond_1

    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->l1:Lorg/reactivestreams/e;
    ...
    .line 23
    iget-boolean v5, p0, Lio/reactivex/internal/subscribers/h;->Y:Z
    ...
    .line 25
    iget v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->j1:I

    invoke-static {v7}, Lio/reactivex/processors/UnicastProcessor;->R8(I)Lio/reactivex/processors/UnicastProcessor;
    ...
    .line 29
    :cond_9
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->i1:Lio/reactivex/h0$c;
    ...
    iget-wide v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->f1:J

    iget-object v9, p0, Lio/reactivex/internal/operators/flowable/k1$c;->h1:Ljava/util/concurrent/TimeUnit;
    ...
    .line 34
    iput-boolean v3, p0, Lio/reactivex/internal/operators/flowable/k1$c;->m1:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->k1:Ljava/util/List;
...
.method public onSubscribe(Lorg/reactivestreams/e;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->l1:Lorg/reactivestreams/e;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/k1$c;->l1:Lorg/reactivestreams/e;
    ...
    .line 6
    iget v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->j1:I
    ...
    .line 7
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/k1$c;->k1:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 8
    iget-object v3, p0, Lio/reactivex/internal/subscribers/h;->W:Lorg/reactivestreams/d;
    ...
    iget-wide v5, p0, Lio/reactivex/internal/operators/flowable/k1$c;->f1:J

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/k1$c;->h1:Ljava/util/concurrent/TimeUnit;
    ...
    .line 11
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/k1$c;->i1:Lio/reactivex/h0$c;

    iget-wide v11, p0, Lio/reactivex/internal/operators/flowable/k1$c;->g1:J

    iget-object v13, p0, Lio/reactivex/internal/operators/flowable/k1$c;->h1:Ljava/util/concurrent/TimeUnit;
...
.method public run()V
    ...
    .line 1
    iget v0, p0, Lio/reactivex/internal/operators/flowable/k1$c;->j1:I
