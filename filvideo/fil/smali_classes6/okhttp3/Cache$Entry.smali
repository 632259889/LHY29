...
.method public static constructor <clinit>()V
    ...
    invoke-virtual {v2}, Lokhttp3/internal/platform/h;->i()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/platform/h;->i()Ljava/lang/String;
...
.method public constructor <init>(Lokio/p0;)V
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/o;)I
    ...
    .line 9
    sget-object v1, Lokhttp3/internal/http/k;->h:Lokhttp3/internal/http/k$a;

    invoke-interface {v0}, Lokio/o;->b2()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lokhttp3/internal/http/k$a;->b(Ljava/lang/String;)Lokhttp3/internal/http/k;

    move-result-object v1

    .line 10
    iget-object v2, v1, Lokhttp3/internal/http/k;->a:Lokhttp3/Protocol;
    ...
    .line 28
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/o;)Ljava/util/List;
...
.method private final readCertificateList(Lokio/o;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/o;)I
    ...
    .line 5
    invoke-interface {p1}, Lokio/o;->b2()Ljava/lang/String;

    move-result-object v4

    .line 6
    new-instance v5, Lokio/m;

    invoke-direct {v5}, Lokio/m;-><init>()V
    ...
    invoke-virtual {v5, v4}, Lokio/m;->c1(Lokio/ByteString;)Lokio/m;

    .line 8
    invoke-virtual {v5}, Lokio/m;->s5()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/n;Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lokio/n;->J2(J)Lokio/n;
    ...
    .line 5
    invoke-interface {p1, v3}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;

    move-result-object v3

    invoke-interface {v3, v1}, Lokio/n;->writeByte(I)Lokio/n;
    :try_end_0
...
.method public final response(Lokhttp3/internal/cache/DiskLruCache$c;)Lokhttp3/Response;
    .locals 5
    ...
    invoke-direct {v3, p1, v0, v1}, Lokhttp3/Cache$CacheResponseBody;-><init>(Lokhttp3/internal/cache/DiskLruCache$c;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->f(I)Lokio/n0;
    ...
    invoke-interface {p1, v3, v4}, Lokio/n;->J2(J)Lokio/n;
    ...
    invoke-interface {p1, v5}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;
    ...
    invoke-interface {v4, v5}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;

    move-result-object v4

    .line 9
    invoke-interface {v4, v2}, Lokio/n;->writeByte(I)Lokio/n;
    ...
    invoke-direct {v1, v3, v5, v6}, Lokhttp3/internal/http/k;-><init>(Lokhttp3/Protocol;ILjava/lang/String;)V
    ...
    invoke-interface {p1, v5, v6}, Lokio/n;->J2(J)Lokio/n;
    ...
    invoke-interface {v3, v5}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;

    move-result-object v3

    .line 16
    invoke-interface {v3, v2}, Lokio/n;->writeByte(I)Lokio/n;
    ...
    invoke-interface {v0, v5, v6}, Lokio/n;->J2(J)Lokio/n;
    ...
    invoke-interface {v0, v3, v4}, Lokio/n;->J2(J)Lokio/n;
    ...
    .line 26
    invoke-interface {p1, v2}, Lokio/n;->writeByte(I)Lokio/n;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lokio/n;Ljava/util/List;)V
