...
.field private static final afterBoundaryOptions:Lokio/f0;
...
.field private final source:Lokio/o;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lokio/f0;->d:Lokio/f0$a;
    ...
    .line 6
    invoke-virtual {v0, v1}, Lokio/f0$a;->d([Lokio/ByteString;)Lokio/f0;

    move-result-object v0

    sput-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/f0;
...
.method public constructor <init>(Lokhttp3/ResponseBody;)V
    ...
    .line 10
    invoke-virtual {p1}, Lokhttp3/ResponseBody;->source()Lokio/o;
    ...
    .line 12
    invoke-direct {p0, v0, p1}, Lokhttp3/MultipartReader;-><init>(Lokio/o;Ljava/lang/String;)V
...
.method public constructor <init>(Lokio/o;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lokhttp3/MultipartReader;->source:Lokio/o;
    ...
    .line 3
    invoke-virtual {p1, v0}, Lokio/m;->N1(Ljava/lang/String;)Lokio/m;

    move-result-object p1

    .line 4
    invoke-virtual {p1, p2}, Lokio/m;->N1(Ljava/lang/String;)Lokio/m;

    move-result-object p1

    .line 5
    invoke-virtual {p1}, Lokio/m;->s4()Lokio/ByteString;
...
.method public static final synthetic access$getAfterBoundaryOptions$cp()Lokio/f0;
    .locals 1

    .line 1
    sget-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/f0;
...
.method public static final synthetic access$getSource$p(Lokhttp3/MultipartReader;)Lokio/o;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/MultipartReader;->source:Lokio/o;
...
.method private final currentPartBytesRemaining(J)J
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/MultipartReader;->source:Lokio/o;
    ...
    invoke-virtual {v0, v1}, Lokio/m;->t(Lokio/ByteString;)J
...
.method public final nextPart()Lokhttp3/MultipartReader$Part;
    ...
    invoke-interface {v0, v3, v4, v5}, Lokio/o;->u1(JLokio/ByteString;)Z
    ...
    .line 7
    :goto_2
    iget-object v3, p0, Lokhttp3/MultipartReader;->source:Lokio/o;

    sget-object v4, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/f0;

    invoke-interface {v3, v4}, Lokio/o;->u5(Lokio/f0;)I
    ...
    iget-object v1, p0, Lokhttp3/MultipartReader;->source:Lokio/o;

    invoke-direct {v0, v1}, Lokhttp3/internal/http1/a;-><init>(Lokio/o;)V

    invoke-virtual {v0}, Lokhttp3/internal/http1/a;->b()Lokhttp3/Headers;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/MultipartReader$Part;-><init>(Lokhttp3/Headers;Lokio/o;)V
    ...
    invoke-interface {v0, v5, v6}, Lokio/o;->skip(J)V
