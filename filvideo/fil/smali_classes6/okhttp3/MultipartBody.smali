...
.method private final writeOrCountBytes(Lokio/n;Z)J
    .locals 12
    ...
    invoke-interface {p1, v8}, Lokio/n;->write([B)Lokio/n;

    .line 7
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v8}, Lokio/n;->U4(Lokio/ByteString;)Lokio/n;
    ...
    invoke-interface {p1, v10}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;
    ...
    invoke-interface {v10, v11}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;
    ...
    .line 15
    invoke-interface {p1, v8}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;
    ...
    invoke-interface {v8, v7}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;
    ...
    invoke-interface {v7, v8}, Lokio/n;->write([B)Lokio/n;
    ...
    .line 19
    invoke-interface {p1, v9}, Lokio/n;->r1(Ljava/lang/String;)Lokio/n;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Lokio/n;->J2(J)Lokio/n;
    ...
    invoke-interface {v9, v10}, Lokio/n;->write([B)Lokio/n;
    ...
    invoke-interface {p1, v9}, Lokio/n;->write([B)Lokio/n;
    ...
    .line 24
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lokio/n;)V
    ...
    invoke-interface {p1, v1}, Lokio/n;->write([B)Lokio/n;

    .line 27
    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v2}, Lokio/n;->U4(Lokio/ByteString;)Lokio/n;
...
.method public contentLength()J
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/n;Z)J
...
.method public writeTo(Lokio/n;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/n;Z)J
