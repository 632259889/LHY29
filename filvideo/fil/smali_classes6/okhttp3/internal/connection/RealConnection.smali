...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "z",
        "(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/g;)Lokhttp3/internal/http/d;",
        ...
        "isMultiplexed",
        "<init>",
        "(Lokhttp3/internal/connection/g;Lokhttp3/Route;)V",
        "okhttp"
    }
    k = 0x1
    mv = {
...
# static fields
.field private static final t:Ljava/lang/String; = "throw with null exception"

.field private static final u:I = 0x15

.field public static final v:J = 0x2540be400L

.field public static final w:Lokhttp3/internal/connection/RealConnection$a;
...
.field private g:Lokhttp3/internal/http2/d;

.field private h:Lokio/o;

.field private i:Lokio/n;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/connection/RealConnection;->w:Lokhttp3/internal/connection/RealConnection$a;

    return-void
.end method

.method public constructor <init>(Lokhttp3/internal/connection/g;Lokhttp3/Route;)V
    .locals 1
...
.method private final H(I)V
    ...
    .line 2
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;

    invoke-static {v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    .line 3
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->i:Lokio/n;
    ...
    sget-object v5, Lokhttp3/internal/concurrent/d;->h:Lokhttp3/internal/concurrent/d;

    const/4 v6, 0x1

    invoke-direct {v4, v6, v5}, Lokhttp3/internal/http2/d$b;-><init>(ZLokhttp3/internal/concurrent/d;)V
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/d$b;->y(Ljava/net/Socket;Ljava/lang/String;Lokio/o;Lokio/n;)Lokhttp3/internal/http2/d$b;
    ...
    .line 11
    sget-object v0, Lokhttp3/internal/http2/d;->K:Lokhttp3/internal/http2/d$c;

    invoke-virtual {v0}, Lokhttp3/internal/http2/d$c;->a()Lokhttp3/internal/http2/k;

    move-result-object v0

    invoke-virtual {v0}, Lokhttp3/internal/http2/k;->f()I
    ...
    .line 12
    invoke-static {p1, v3, v0, v1, v0}, Lokhttp3/internal/http2/d;->M1(Lokhttp3/internal/http2/d;ZLokhttp3/internal/concurrent/d;ILjava/lang/Object;)V

    return-void
.end method

.method private final I(Lokhttp3/HttpUrl;)Z
    .locals 4
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/connection/RealConnection;->h(Lokhttp3/HttpUrl;Lokhttp3/Handshake;)Z
...
.method public static final synthetic e(Lokhttp3/internal/connection/RealConnection;Lokhttp3/Handshake;)V
    ...
    .line 1
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->e:Lokhttp3/Handshake;
...
.method private final h(Lokhttp3/HttpUrl;Lokhttp3/Handshake;)Z
    .locals 4
    ...
    sget-object v0, Lokhttp3/internal/tls/d;->c:Lokhttp3/internal/tls/d;
    ...
    .line 4
    invoke-virtual {v0, p1, p2}, Lokhttp3/internal/tls/d;->c(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
...
.method private final k(IILokhttp3/Call;Lokhttp3/EventListener;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    sget-object v3, Lokhttp3/internal/connection/f;->$EnumSwitchMapping$0:[I
    ...
    invoke-virtual {p2, v1, p3, p1}, Lokhttp3/internal/platform/h;->g(Ljava/net/Socket;Ljava/net/InetSocketAddress;I)V
    :try_end_0
    .catch Ljava/net/ConnectException; {:try_start_0 .. :try_end_0} :catch_1

    .line 10
    :try_start_1
    invoke-static {v1}, Lokio/c0;->t(Ljava/net/Socket;)Lokio/p0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;

    .line 11
    invoke-static {v1}, Lokio/c0;->o(Ljava/net/Socket;)Lokio/n0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->i:Lokio/n;
    :try_end_1
...
.method private final l(Lokhttp3/internal/connection/b;)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 6
    :try_start_1
    invoke-virtual {p1, v1}, Lokhttp3/internal/connection/b;->a(Ljavax/net/ssl/SSLSocket;)Lokhttp3/ConnectionSpec;
    ...
    invoke-virtual {v3, v1, v4, v5}, Lokhttp3/internal/platform/h;->f(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 32
    sget-object p1, Lokhttp3/internal/platform/h;->e:Lokhttp3/internal/platform/h$a;

    invoke-virtual {p1}, Lokhttp3/internal/platform/h$a;->g()Lokhttp3/internal/platform/h;

    move-result-object p1

    invoke-virtual {p1, v1}, Lokhttp3/internal/platform/h;->j(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lokhttp3/internal/platform/h;->c(Ljavax/net/ssl/SSLSocket;)V
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/platform/h;->c(Ljavax/net/ssl/SSLSocket;)V
...
.method private final m(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-direct {p0}, Lokhttp3/internal/connection/RealConnection;->o()Lokhttp3/Request;
    ...
    .line 3
    invoke-direct {p0, p1, p2, p4, p5}, Lokhttp3/internal/connection/RealConnection;->k(IILokhttp3/Call;Lokhttp3/EventListener;)V

    .line 4
    invoke-direct {p0, p2, p3, v0, v1}, Lokhttp3/internal/connection/RealConnection;->n(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->i:Lokio/n;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;
...
.method private final n(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p4, v1}, Lokhttp3/internal/d;->a0(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    .line 2
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/b;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/o;Lokio/n;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Lokio/r0;->i(JLjava/util/concurrent/TimeUnit;)Lokio/r0;

    .line 6
    invoke-interface {v2}, Lokio/n0;->timeout()Lokio/r0;
    ...
    invoke-virtual {v3, v5, p4}, Lokhttp3/internal/http1/b;->C(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 9
    invoke-virtual {v3, v5}, Lokhttp3/internal/http1/b;->g(Z)Lokhttp3/Response$Builder;
    ...
    .line 12
    invoke-virtual {v3, p3}, Lokhttp3/internal/http1/b;->B(Lokhttp3/Response;)V
    ...
    invoke-virtual {p1}, Lokio/m;->u3()Z
...
.method private final o()Lokhttp3/Request;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v1, v2}, Lokhttp3/internal/d;->a0(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    .line 13
    sget-object v2, Lokhttp3/internal/d;->c:Lokhttp3/ResponseBody;
...
.method private final p(Lokhttp3/internal/connection/b;ILokhttp3/Call;Lokhttp3/EventListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 5
    invoke-direct {p0, p2}, Lokhttp3/internal/connection/RealConnection;->H(I)V
    ...
    .line 9
    invoke-direct {p0, p1}, Lokhttp3/internal/connection/RealConnection;->l(Lokhttp3/internal/connection/b;)V
...
.method public final A(Lokhttp3/internal/connection/c;)Lokhttp3/internal/ws/e$d;
    ...
    .line 2
    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;

    invoke-static {v6}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    .line 3
    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->i:Lokio/n;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/connection/RealConnection$b;-><init>(Lokhttp3/internal/connection/c;Lokio/o;Lokio/n;ZLokio/o;Lokio/n;)V
...
.method public final declared-synchronized J(Lokhttp3/internal/connection/e;Ljava/io/IOException;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lokhttp3/internal/connection/RealConnection;->j(Lokhttp3/OkHttpClient;Lokhttp3/Route;Ljava/io/IOException;)V
...
.method public declared-synchronized a(Lokhttp3/internal/http2/d;Lokhttp3/internal/http2/k;)V
    ...
    .line 1
    invoke-virtual {p2}, Lokhttp3/internal/http2/k;->f()I
...
.method public final i(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-virtual {v1, v0}, Lokhttp3/internal/platform/h;->l(Ljava/lang/String;)Z
    ...
    .line 14
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/connection/RealConnection;->m(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 16
    :try_start_1
    invoke-direct {v7, v14, v15, v8, v9}, Lokhttp3/internal/connection/RealConnection;->k(IILokhttp3/Call;Lokhttp3/EventListener;)V
    :try_end_1
    ...
    .line 17
    :try_start_2
    invoke-direct {v7, v11, v6, v8, v9}, Lokhttp3/internal/connection/RealConnection;->p(Lokhttp3/internal/connection/b;ILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 26
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;

    .line 27
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->i:Lokio/n;
...
.method public final j(Lokhttp3/OkHttpClient;Lokhttp3/Route;Ljava/io/IOException;)V
    .locals 3
    ...
    .line 6
    :cond_0
    invoke-virtual {p1}, Lokhttp3/OkHttpClient;->getRouteDatabase()Lokhttp3/internal/connection/h;

    move-result-object p1

    invoke-virtual {p1, p2}, Lokhttp3/internal/connection/h;->b(Lokhttp3/Route;)V
...
.method public final r()Lokhttp3/internal/connection/g;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->r:Lokhttp3/internal/connection/g;
...
.method public final w(Lokhttp3/Address;Ljava/util/List;)Z
    .locals 3
    ...
    .line 7
    invoke-direct {p0, p2}, Lokhttp3/internal/connection/RealConnection;->D(Ljava/util/List;)Z
    ...
    invoke-direct {p0, p2}, Lokhttp3/internal/connection/RealConnection;->I(Lokhttp3/HttpUrl;)Z
...
.method public final x(Z)Z
    ...
    .line 6
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->h:Lokio/o;
    ...
    .line 9
    invoke-virtual {v2, v0, v1}, Lokhttp3/internal/http2/d;->Y0(J)Z
    ...
    .line 11
    invoke-static {v3, v4}, Lokhttp3/internal/d;->K(Ljava/net/Socket;Lokio/o;)Z
...
.method public final z(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/g;)Lokhttp3/internal/http/d;
    .locals 6
    .param p1    # Lokhttp3/OkHttpClient;
        .annotation build Lorg/jetbrains/annotations/b;
        .end annotation
    ...
    invoke-direct {v0, p1, p0, p2, v3}, Lokhttp3/internal/http2/e;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokhttp3/internal/http/g;Lokhttp3/internal/http2/d;)V
    ...
    .line 7
    invoke-interface {v1}, Lokio/p0;->timeout()Lokio/r0;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lokio/r0;->i(JLjava/util/concurrent/TimeUnit;)Lokio/r0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/b;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/o;Lokio/n;)V
