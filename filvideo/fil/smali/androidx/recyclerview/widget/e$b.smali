...
# interfaces
.implements Landroidx/recyclerview/widget/h0$a;
...
# instance fields
.field private a:Landroidx/recyclerview/widget/i0$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private e()Landroidx/recyclerview/widget/i0$a;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Landroidx/recyclerview/widget/e$b;->a:Landroidx/recyclerview/widget/i0$a;

    if-eqz v0, :cond_0

    .line 2
    iget-object v1, v0, Landroidx/recyclerview/widget/i0$a;->d:Landroidx/recyclerview/widget/i0$a;

    iput-object v1, p0, Landroidx/recyclerview/widget/e$b;->a:Landroidx/recyclerview/widget/i0$a;
    ...
    invoke-direct {v0, v2, v1}, Landroidx/recyclerview/widget/i0$a;-><init>(Ljava/lang/Class;I)V

    return-object v0
.end method

.method private f(Landroidx/recyclerview/widget/i0$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget v1, p1, Landroidx/recyclerview/widget/i0$a;->b:I
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/e;->f:Landroidx/recyclerview/widget/h0$b;

    iget v1, p0, Landroidx/recyclerview/widget/e$b;->c:I

    invoke-interface {v0, v1, p1}, Landroidx/recyclerview/widget/h0$b;->b(ILandroidx/recyclerview/widget/i0$a;)V
...
.method private k(I)V
    ...
    invoke-interface {v0, v1, p1}, Landroidx/recyclerview/widget/h0$b;->a(II)V
...
.method private l(IIIZ)V
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/e;->g:Landroidx/recyclerview/widget/h0$a;

    invoke-interface {v2, v1, p3}, Landroidx/recyclerview/widget/h0$a;->b(II)V
...
.method public b(II)V
    ...
    .line 2
    :cond_0
    invoke-direct {p0}, Landroidx/recyclerview/widget/e$b;->e()Landroidx/recyclerview/widget/i0$a;

    move-result-object v0

    .line 3
    iput p1, v0, Landroidx/recyclerview/widget/i0$a;->b:I
    ...
    iput p1, v0, Landroidx/recyclerview/widget/i0$a;->c:I
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/i0$a;->a:[Ljava/lang/Object;

    iget v3, v0, Landroidx/recyclerview/widget/i0$a;->b:I
    ...
    .line 7
    invoke-direct {p0, v0}, Landroidx/recyclerview/widget/e$b;->f(Landroidx/recyclerview/widget/i0$a;)V
...
.method public c(I)V
    ...
    invoke-interface {v0, v1, p1}, Landroidx/recyclerview/widget/h0$b;->c(II)V

    return-void
.end method

.method public d(Landroidx/recyclerview/widget/i0$a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/i0$a;->a:[Ljava/lang/Object;

    iget v2, p1, Landroidx/recyclerview/widget/i0$a;->c:I
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/i0$a;->d:Landroidx/recyclerview/widget/i0$a;

    .line 3
    iput-object p1, p0, Landroidx/recyclerview/widget/e$b;->a:Landroidx/recyclerview/widget/i0$a;
