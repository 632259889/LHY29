.class Landroidx/media2/session/w$r;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/media2/session/w;->o(Landroid/net/Uri;Landroid/os/Bundle;)V
.end annotation
...
.method public constructor <init>(Landroidx/media2/session/w;Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/media2/session/w$r;->c:Landroidx/media2/session/w;

    iput-object p2, p0, Landroidx/media2/session/w$r;->a:Landroid/net/Uri;

    iput-object p3, p0, Landroidx/media2/session/w$r;->b:Landroid/os/Bundle;
...
.method public a(Landroidx/media2/session/MediaSession$d;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media2/session/w$r;->c:Landroidx/media2/session/w;
    ...
    iget-object v1, p0, Landroidx/media2/session/w$r;->c:Landroidx/media2/session/w;
    ...
    iget-object v2, p0, Landroidx/media2/session/w$r;->a:Landroid/net/Uri;

    iget-object v3, p0, Landroidx/media2/session/w$r;->b:Landroid/os/Bundle;
    ...
    .line 2
    iget-object p1, p0, Landroidx/media2/session/w$r;->c:Landroidx/media2/session/w;
