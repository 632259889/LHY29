...
.method private b(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 12
    :cond_5
    new-instance v1, Landroidx/constraintlayout/widget/i$b;

    invoke-direct {v1, p1, p2}, Landroidx/constraintlayout/widget/i$b;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    if-eqz v0, :cond_8

    .line 13
    invoke-virtual {v0, v1}, Landroidx/constraintlayout/widget/i$a;->a(Landroidx/constraintlayout/widget/i$b;)V

    goto :goto_3

    .line 14
    :cond_6
    new-instance v0, Landroidx/constraintlayout/widget/i$a;

    invoke-direct {v0, p1, p2}, Landroidx/constraintlayout/widget/i$a;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    .line 15
    iget-object v1, p0, Landroidx/constraintlayout/widget/i;->e:Landroid/util/SparseArray;

    iget v3, v0, Landroidx/constraintlayout/widget/i$a;->a:I
...
.method public a(IIFF)I
    ...
    .line 2
    iget-object v1, v0, Landroidx/constraintlayout/widget/i$a;->b:Ljava/util/ArrayList;
    ...
    .line 4
    iget p2, v2, Landroidx/constraintlayout/widget/i$b;->f:I
    ...
    .line 5
    iget p1, p2, Landroidx/constraintlayout/widget/i$b;->f:I
