...
.field private final c:Landroidx/core/app/s$g;
...
.method public constructor <init>(Landroidx/core/app/s$g;)V
    ...
    .line 4
    iput-object p1, p0, Landroidx/core/app/t;->c:Landroidx/core/app/s$g;

    .line 5
    iget-object v0, p1, Landroidx/core/app/s$g;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Landroidx/core/app/s$g;->a:Landroid/content/Context;

    iget-object v4, p1, Landroidx/core/app/s$g;->L:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Landroidx/core/app/t;->b:Landroid/app/Notification$Builder;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Landroidx/core/app/s$g;->U:Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroidx/core/app/s$g;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/s$g;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/s$g;->l:I
    ...
    iget v4, p1, Landroidx/core/app/s$g;->u:I

    iget v9, p1, Landroidx/core/app/s$g;->v:I

    iget-boolean v10, p1, Landroidx/core/app/s$g;->w:Z
    ...
    .line 29
    iget-object v4, p0, Landroidx/core/app/t;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v8, p1, Landroidx/core/app/s$g;->r:Ljava/lang/CharSequence;
    ...
    iget-boolean v8, p1, Landroidx/core/app/s$g;->o:Z
    ...
    check-cast v8, Landroidx/core/app/s$b;

    .line 34
    invoke-direct {p0, v8}, Landroidx/core/app/t;->b(Landroidx/core/app/s$b;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Landroidx/core/app/s$g;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Landroidx/core/app/t;->g:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Landroidx/core/app/s$g;->A:Z
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Landroidx/core/app/s$g;->x:Ljava/lang/String;
    ...
    .line 42
    iget-boolean v0, p1, Landroidx/core/app/s$g;->y:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Landroidx/core/app/s$g;->z:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Landroidx/core/app/s$g;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/t;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Landroidx/core/app/s$g;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/t;->e:Landroid/widget/RemoteViews;
    ...
    .line 50
    iget-object v8, p0, Landroidx/core/app/t;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Landroidx/core/app/s$g;->n:Z
    ...
    .line 51
    iget-object v8, p1, Landroidx/core/app/s$g;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Landroidx/core/app/t;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Landroidx/core/app/s$g;->X:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Landroidx/core/app/t;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Landroidx/core/app/t;->g:Landroid/os/Bundle;
    ...
    iget-boolean v8, p1, Landroidx/core/app/s$g;->y:Z
    ...
    iget v8, p1, Landroidx/core/app/s$g;->G:I
    ...
    iget-object v8, p1, Landroidx/core/app/s$g;->H:Landroid/app/Notification;
    ...
    .line 66
    iget-object v0, p1, Landroidx/core/app/s$g;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Landroidx/core/app/t;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Landroidx/core/app/s$g;->X:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Landroidx/core/app/t;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Landroidx/core/app/s$g;->X:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Landroidx/core/app/s$g;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/t;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Landroidx/core/app/s$g;->d:Ljava/util/ArrayList;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Landroidx/core/app/s$g;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Landroidx/core/app/s$g;->d:Ljava/util/ArrayList;
    ...
    check-cast v12, Landroidx/core/app/s$b;

    .line 80
    invoke-static {v12}, Landroidx/core/app/v;->j(Landroidx/core/app/s$b;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Landroidx/core/app/s$g;->W:Landroid/graphics/drawable/Icon;
    ...
    iget-object v8, p1, Landroidx/core/app/s$g;->E:Landroid/os/Bundle;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v8, p1, Landroidx/core/app/s$g;->t:[Ljava/lang/CharSequence;
    ...
    .line 91
    iget-object v3, p1, Landroidx/core/app/s$g;->I:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Landroidx/core/app/s$g;->J:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Landroidx/core/app/s$g;->K:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Landroidx/core/app/s$g;->N:Ljava/lang/String;
    ...
    iget-wide v9, p1, Landroidx/core/app/s$g;->P:J
    ...
    iget-boolean v9, p1, Landroidx/core/app/s$g;->B:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    .line 104
    :cond_19
    iget-object v8, p1, Landroidx/core/app/s$g;->L:Ljava/lang/String;
    ...
    check-cast v4, Landroidx/core/app/a0;
    ...
    iget-boolean v7, p1, Landroidx/core/app/s$g;->S:Z
    ...
    iget-object v7, p1, Landroidx/core/app/s$g;->T:Landroidx/core/app/s$f;

    .line 114
    invoke-static {v7}, Landroidx/core/app/s$f;->k(Landroidx/core/app/s$f;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 116
    iget-object v4, p1, Landroidx/core/app/s$g;->O:Landroidx/core/content/g;
    ...
    invoke-virtual {v4}, Landroidx/core/content/g;->c()Landroid/content/LocusId;
    ...
    .line 118
    iget v4, p1, Landroidx/core/app/s$g;->R:I
    ...
    .line 120
    :cond_1d
    iget-boolean p1, p1, Landroidx/core/app/s$g;->V:Z

    if-eqz p1, :cond_20

    .line 121
    iget-object p1, p0, Landroidx/core/app/t;->c:Landroidx/core/app/s$g;

    iget-boolean p1, p1, Landroidx/core/app/s$g;->y:Z
    ...
    .line 123
    :cond_1e
    iput v6, p0, Landroidx/core/app/t;->h:I
    ...
    iget-object p1, p1, Landroidx/core/app/s$g;->x:Ljava/lang/String;
...
.method private b(Landroidx/core/app/s$b;)V
    .locals 5
    ...
    .line 5
    :goto_0
    invoke-virtual {p1}, Landroidx/core/app/s$b;->j()Ljava/lang/CharSequence;

    move-result-object v2

    .line 6
    invoke-virtual {p1}, Landroidx/core/app/s$b;->a()Landroid/app/PendingIntent;
    ...
    .line 13
    invoke-static {v1}, Landroidx/core/app/c0;->d([Landroidx/core/app/c0;)[Landroid/app/RemoteInput;
    ...
    .line 27
    :cond_8
    invoke-virtual {p1}, Landroidx/core/app/s$b;->i()Z
    ...
    .line 31
    iget-object v0, p0, Landroidx/core/app/t;->f:Ljava/util/List;

    iget-object v1, p0, Landroidx/core/app/t;->b:Landroid/app/Notification$Builder;

    .line 32
    invoke-static {v1, p1}, Landroidx/core/app/v;->o(Landroid/app/Notification$Builder;Landroidx/core/app/s$b;)Landroid/os/Bundle;
...
.method private static g(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v1}, Landroidx/core/app/a0;->j()Ljava/lang/String;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Landroidx/core/app/t;->c:Landroidx/core/app/s$g;

    iget-object v0, v0, Landroidx/core/app/s$g;->q:Landroidx/core/app/s$q;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Landroidx/core/app/s$q;->b(Landroidx/core/app/p;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Landroidx/core/app/s$q;->w(Landroidx/core/app/p;)Landroid/widget/RemoteViews;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Landroidx/core/app/t;->c:Landroidx/core/app/s$g;

    iget-object v1, v1, Landroidx/core/app/s$g;->I:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Landroidx/core/app/s$q;->v(Landroidx/core/app/p;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Landroidx/core/app/t;->c:Landroidx/core/app/s$g;

    iget-object v4, v4, Landroidx/core/app/s$g;->q:Landroidx/core/app/s$q;

    .line 12
    invoke-virtual {v4, p0}, Landroidx/core/app/s$q;->x(Landroidx/core/app/p;)Landroid/widget/RemoteViews;
    ...
    .line 14
    invoke-static {v2}, Landroidx/core/app/s;->n(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {v0, v1}, Landroidx/core/app/s$q;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    .line 6
    invoke-direct {p0, v0}, Landroidx/core/app/t;->h(Landroid/app/Notification;)V
    ...
    .line 34
    invoke-static {v0}, Landroidx/core/app/v;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 43
    invoke-static {v0}, Landroidx/core/app/s;->n(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Landroidx/core/app/t;->g:Landroid/os/Bundle;
    ...
    .line 49
    iget-object v1, p0, Landroidx/core/app/t;->f:Ljava/util/List;

    .line 50
    invoke-static {v1}, Landroidx/core/app/v;->a(Ljava/util/List;)Landroid/util/SparseArray;
