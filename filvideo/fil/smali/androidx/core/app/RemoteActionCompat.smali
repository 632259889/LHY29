...
# instance fields
.field public q:Landroidx/core/graphics/drawable/IconCompat;
...
.method public constructor <init>(Landroidx/core/app/RemoteActionCompat;)V
    ...
    .line 11
    iget-object v0, p1, Landroidx/core/app/RemoteActionCompat;->q:Landroidx/core/graphics/drawable/IconCompat;

    iput-object v0, p0, Landroidx/core/app/RemoteActionCompat;->q:Landroidx/core/graphics/drawable/IconCompat;

    .line 12
    iget-object v0, p1, Landroidx/core/app/RemoteActionCompat;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroidx/core/app/RemoteActionCompat;->r:Ljava/lang/CharSequence;

    .line 13
    iget-object v0, p1, Landroidx/core/app/RemoteActionCompat;->s:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroidx/core/app/RemoteActionCompat;->s:Ljava/lang/CharSequence;

    .line 14
    iget-object v0, p1, Landroidx/core/app/RemoteActionCompat;->t:Landroid/app/PendingIntent;

    iput-object v0, p0, Landroidx/core/app/RemoteActionCompat;->t:Landroid/app/PendingIntent;

    .line 15
    iget-boolean v0, p1, Landroidx/core/app/RemoteActionCompat;->u:Z

    iput-boolean v0, p0, Landroidx/core/app/RemoteActionCompat;->u:Z

    .line 16
    iget-boolean p1, p1, Landroidx/core/app/RemoteActionCompat;->v:Z

    iput-boolean p1, p0, Landroidx/core/app/RemoteActionCompat;->v:Z
...
.method public constructor <init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    iput-object p1, p0, Landroidx/core/app/RemoteActionCompat;->q:Landroidx/core/graphics/drawable/IconCompat;

    .line 3
    invoke-static {p2}, Landroidx/core/util/o;->l(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ljava/lang/CharSequence;

    iput-object p1, p0, Landroidx/core/app/RemoteActionCompat;->r:Ljava/lang/CharSequence;

    .line 4
    invoke-static {p3}, Landroidx/core/util/o;->l(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ljava/lang/CharSequence;

    iput-object p1, p0, Landroidx/core/app/RemoteActionCompat;->s:Ljava/lang/CharSequence;

    .line 5
    invoke-static {p4}, Landroidx/core/util/o;->l(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/app/PendingIntent;

    iput-object p1, p0, Landroidx/core/app/RemoteActionCompat;->t:Landroid/app/PendingIntent;

    const/4 p1, 0x1

    .line 6
    iput-boolean p1, p0, Landroidx/core/app/RemoteActionCompat;->u:Z
...
.method public static c(Landroid/app/RemoteAction;)Landroidx/core/app/RemoteActionCompat;
    .locals 5
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/RemoteActionCompat;->p(Z)V
    ...
    invoke-virtual {v0, p0}, Landroidx/core/app/RemoteActionCompat;->q(Z)V
...
.method public r()Z
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/core/app/RemoteActionCompat;->v:Z

    return v0
.end method

.method public s()Landroid/app/RemoteAction;
    .locals 4
    .annotation build Landroidx/annotation/i;
        value = 0x1a
    .end annotation
    ...
    iget-object v1, p0, Landroidx/core/app/RemoteActionCompat;->r:Ljava/lang/CharSequence;

    iget-object v2, p0, Landroidx/core/app/RemoteActionCompat;->s:Ljava/lang/CharSequence;

    iget-object v3, p0, Landroidx/core/app/RemoteActionCompat;->t:Landroid/app/PendingIntent;
    ...
    .line 4
    invoke-virtual {p0}, Landroidx/core/app/RemoteActionCompat;->r()Z
