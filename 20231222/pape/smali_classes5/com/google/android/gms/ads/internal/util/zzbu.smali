...
.method public static zza(Lorg/json/b;)Landroid/os/Bundle;
    .locals 10
    ...
    .line 20
    invoke-virtual {v4, v8}, Lorg/json/a;->i(I)Z

    move-result v7

    if-nez v7, :cond_7

    invoke-virtual {v4, v8}, Lorg/json/a;->l(I)Ljava/lang/Object;
    ...
    .line 24
    invoke-virtual {v4, v6}, Lorg/json/a;->i(I)Z
    ...
    invoke-static {v8}, Lcom/google/android/gms/ads/internal/util/zzbu;->zza(Lorg/json/b;)Landroid/os/Bundle;
    ...
    .line 28
    invoke-virtual {v4, v6}, Lorg/json/a;->o(I)D
    ...
    invoke-virtual {v4, v6}, Lorg/json/a;->w(I)Ljava/lang/String;
    ...
    .line 36
    invoke-virtual {v4, v6}, Lorg/json/a;->m(I)Z
    ...
    invoke-static {v4}, Lcom/google/android/gms/ads/internal/util/zzbu;->zza(Lorg/json/b;)Landroid/os/Bundle;
...
.method public static varargs zzb(Ljava/lang/String;Lorg/json/b;[Ljava/lang/String;)Ljava/lang/String;
    .locals 1

    .line 1
    invoke-static {p1, p2}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzm(Lorg/json/b;[Ljava/lang/String;)Lorg/json/b;
    ...
    .line 2
    invoke-virtual {p0, p2, p1}, Lorg/json/b;->optString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static zzc(Lorg/json/a;Ljava/util/List;)Ljava/util/List;
    .locals 2
...
.method public static zze(Landroid/util/JsonReader;)Lorg/json/a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
    ...
    .line 6
    invoke-static {p0}, Lcom/google/android/gms/ads/internal/util/zzbu;->zze(Landroid/util/JsonReader;)Lorg/json/a;
    ...
    .line 8
    invoke-static {p0}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzh(Landroid/util/JsonReader;)Lorg/json/b;
    ...
    invoke-virtual {v0, v1}, Lorg/json/a;->F(Z)Lorg/json/a;
...
.method public static zzf(Lorg/json/b;Ljava/lang/String;)Lorg/json/b;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
...
.method public static varargs zzg(Lorg/json/b;[Ljava/lang/String;)Lorg/json/b;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    .line 1
    invoke-static {p0, p1}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzm(Lorg/json/b;[Ljava/lang/String;)Lorg/json/b;
...
.method public static zzh(Landroid/util/JsonReader;)Lorg/json/b;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public static zzi(Landroid/util/JsonWriter;Lorg/json/a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0, v1}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzj(Landroid/util/JsonWriter;Lorg/json/b;)V
    ...
    invoke-static {p0, v1}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzi(Landroid/util/JsonWriter;Lorg/json/a;)V
...
.method public static zzj(Landroid/util/JsonWriter;Lorg/json/b;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v1, v2}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzj(Landroid/util/JsonWriter;Lorg/json/b;)V
    ...
    invoke-static {v1, v2}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzi(Landroid/util/JsonWriter;Lorg/json/a;)V
...
.method public static varargs zzk(ZLorg/json/b;[Ljava/lang/String;)Z
    .locals 1
    ...
    invoke-virtual {p0, p2, p1}, Lorg/json/b;->optBoolean(Ljava/lang/String;Z)Z
...
.method private static zzm(Lorg/json/b;[Ljava/lang/String;)Lorg/json/b;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method private static zzn(Landroid/util/JsonWriter;Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Lcom/google/android/gms/internal/ads/zzfdp;->zzd:Lorg/json/b;

    .line 10
    invoke-static {p0, p1}, Lcom/google/android/gms/ads/internal/util/zzbu;->zzj(Landroid/util/JsonWriter;Lorg/json/b;)V
