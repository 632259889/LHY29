...
# direct methods
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;Loa/g;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {p1, v6}, Lja/q;->b(Lu9/c;I)Lw9/e;
    ...
    .line 8
    invoke-direct/range {v1 .. v6}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;-><init>(Lja/i;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ll8/a;)V

    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->g:Loa/g;

    .line 9
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->q()Lja/i;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->h:Lma/h;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->i:Lma/h;

    return-void
.end method

.method public static final synthetic A(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;)Loa/g;
    .locals 0

    .line 1
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->g:Loa/g;

    return-object p0
.end method

.method private final B(Lw9/e;Ljava/util/Collection;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    invoke-virtual {v0}, Lja/g;->m()Loa/k;
    ...
    .line 5
    invoke-virtual/range {v0 .. v5}, Lkotlin/reflect/jvm/internal/impl/resolve/OverridingUtil;->w(Lw9/e;Ljava/util/Collection;Ljava/util/Collection;La9/b;Laa/g;)V
...
.method public D(Lw9/e;Li9/b;)V
    ...
    invoke-virtual {v0}, Lja/g;->o()Li9/c;
...
.method public b(Lw9/e;Li9/b;)Ljava/util/Collection;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->D(Lw9/e;Li9/b;)V

    .line 2
    invoke-super {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->b(Lw9/e;Li9/b;)Ljava/util/Collection;
...
.method public c(Lw9/e;Li9/b;)Ljava/util/Collection;
    ...
    .line 2
    invoke-super {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->c(Lw9/e;Li9/b;)Ljava/util/Collection;
...
.method public e(Lga/d;Ll8/l;)Ljava/util/Collection;
    ...
    .line 1
    iget-object p1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->h:Lma/h;
...
.method public f(Lw9/e;Li9/b;)La9/d;
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$EnumEntryClassDescriptors;->f(Lw9/e;)La9/b;
    ...
    .line 3
    :goto_0
    invoke-super {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedMemberScope;->f(Lw9/e;Li9/b;)La9/d;
...
.method protected j(Ljava/util/Collection;Ll8/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected l(Lw9/e;Ljava/util/List;)V
    ...
    .line 2
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->i:Lma/h;
    ...
    invoke-interface {v1, p1, v2}, Lc9/a;->e(Lw9/e;La9/b;)Ljava/util/Collection;
    ...
    .line 5
    invoke-direct {p0, p1, v0, p2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor$DeserializedClassMemberScope;->B(Lw9/e;Ljava/util/Collection;Ljava/util/List;)V
...
.method protected n(Lw9/e;)Lw9/b;
    .locals 1
    ...
    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;->O0(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassDescriptor;)Lw9/b;
...
.method protected u()Ljava/util/Set;
    ...
    invoke-virtual {v2}, Lja/g;->c()Lc9/a;

    move-result-object v2

    invoke-interface {v2, v0}, Lc9/a;->b(La9/b;)Ljava/util/Collection;
...
.method protected y(Lkotlin/reflect/jvm/internal/impl/descriptors/f;)Z
    ...
    invoke-virtual {v0}, Lja/g;->s()Lc9/c;
    ...
    invoke-interface {v0, v1, p1}, Lc9/c;->c(La9/b;Lkotlin/reflect/jvm/internal/impl/descriptors/f;)Z
