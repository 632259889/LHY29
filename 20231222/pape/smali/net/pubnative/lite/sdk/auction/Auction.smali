...
.method private reportAuctionFinished(Lnet/pubnative/lite/sdk/models/Ad;)V
    ...
    invoke-virtual {v0, v2, v1}, Lnet/pubnative/lite/sdk/analytics/ReportingEvent;->setCustomJSONArray(Ljava/lang/String;Lorg/json/a;)V
...
.method private reportAuctionStart()V
    ...
    invoke-virtual {v1, v4, v5, v6}, Lorg/json/b;->put(Ljava/lang/String;D)Lorg/json/b;
    ...
    .line 11
    invoke-virtual {v0, v2, v1}, Lnet/pubnative/lite/sdk/analytics/ReportingEvent;->setCustomJSONObject(Ljava/lang/String;Lorg/json/b;)V
    :try_end_0
