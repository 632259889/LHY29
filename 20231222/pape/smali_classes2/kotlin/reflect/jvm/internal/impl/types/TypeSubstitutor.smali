...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lna/q0;->b:Lna/q0;
...
.method protected constructor <init>(Lna/q0;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;
...
.method private static b(ILna/n0;Lna/q0;)V
    .locals 2
...
.method public static d(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/n0;)Lkotlin/reflect/jvm/internal/impl/types/Variance;
    .locals 1
    ...
    sget-object p0, Lkotlin/reflect/jvm/internal/impl/types/Variance;->h:Lkotlin/reflect/jvm/internal/impl/types/Variance;
...
.method public static f(Lna/y;)Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    .locals 1
    ...
    invoke-static {v0, p0}, Lna/m0;->i(Lna/l0;Ljava/util/List;)Lna/q0;
...
.method public static g(Lna/q0;)Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;-><init>(Lna/q0;)V

    return-object v0
.end method

.method public static h(Lna/q0;Lna/q0;)Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    .locals 1
    ...
    .line 1
    :cond_1
    invoke-static {p0, p1}, Lna/n;->i(Lna/q0;Lna/q0;)Lna/q0;
...
.method private static i(Lb9/e;)Lb9/e;
    .locals 2
    ...
    .line 1
    :cond_0
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/c$a;->L:Lw9/c;
    ...
    invoke-direct {v0, p0, v1}, Lb9/h;-><init>(Lb9/e;Ll8/l;)V

    return-object v0
.end method

.method private static l(Lna/y;Lna/n0;La9/n0;Lna/n0;)Lna/n0;
    .locals 2
    ...
    .line 7
    invoke-interface {p3}, Lna/n0;->c()Lkotlin/reflect/jvm/internal/impl/types/Variance;
...
.method private static o(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 2
    invoke-static {p0}, Lva/c;->a(Ljava/lang/Throwable;)Z
...
.method private r(Lna/n0;I)Lna/n0;
    .locals 4
    ...
    .line 4
    invoke-static {v0}, Lna/d0;->b(Lna/y;)Lna/b0;
    ...
    invoke-virtual {p1, v2, v3}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->p(Lna/y;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lna/y;
    ...
    .line 8
    iget-object v2, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;

    invoke-interface {v0}, Lb9/a;->getAnnotations()Lb9/e;

    move-result-object v3

    invoke-virtual {v2, v3}, Lna/q0;->d(Lb9/e;)Lb9/e;

    move-result-object v2

    invoke-static {v0, p2, v2}, Lna/r0;->b(Lna/y;Ljava/util/List;Lb9/e;)Lna/y;
    ...
    invoke-static {p2, p1}, Lna/d0;->j(Lna/b0;Lna/b0;)Lna/b0;
    ...
    invoke-direct {p1, v1, p2}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V
...
.method private s(Ljava/util/List;Ljava/util/List;I)Ljava/util/List;
    ...
    .line 5
    invoke-direct {p0, v4, v3, v6}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;
    ...
    invoke-interface {v3}, La9/n0;->l()Lkotlin/reflect/jvm/internal/impl/types/Variance;
    ...
    invoke-direct {v3, v7, v6}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V
    ...
    .line 9
    :cond_1
    invoke-static {v3}, Lna/t0;->t(La9/n0;)Lna/n0;
...
.method private u(Lna/n0;La9/n0;I)Lna/n0;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor$SubstitutionException;
    ...
    .line 1
    :cond_0
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;

    invoke-static {p3, p1, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->b(ILna/n0;Lna/q0;)V
    ...
    .line 5
    check-cast v0, Lna/u0;

    invoke-interface {v0}, Lna/u0;->F0()Lna/x0;

    move-result-object v1

    .line 6
    invoke-interface {v0}, Lna/u0;->h0()Lna/y;
    ...
    invoke-direct {v3, v4, v1}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V

    add-int/2addr p3, v2

    invoke-direct {p0, v3, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;

    move-result-object p2

    .line 8
    invoke-interface {p2}, Lna/n0;->b()Z
    ...
    invoke-virtual {p0, v0, p1}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->p(Lna/y;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lna/y;
    ...
    instance-of v0, p1, Lna/u0;

    if-eqz v0, :cond_3

    check-cast p1, Lna/u0;

    invoke-interface {p1}, Lna/u0;->h0()Lna/y;

    move-result-object p1

    :cond_3
    invoke-static {p3, p1}, Lna/v0;->e(Lna/x0;Lna/y;)Lna/x0;
    ...
    invoke-direct {p3, p2, p1}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V
    ...
    .line 13
    :cond_5
    iget-object v1, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;

    invoke-virtual {v1, v0}, Lna/q0;->e(Lna/y;)Lna/n0;
    ...
    .line 14
    invoke-static {v0, v1, p2, p1}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->l(Lna/y;Lna/n0;La9/n0;Lna/n0;)Lna/n0;
    ...
    invoke-static {v0}, Lna/k0;->b(Lna/y;)Z
    ...
    .line 17
    invoke-static {v0}, Lna/w;->a(Lna/y;)Lna/t;

    move-result-object v0

    .line 18
    new-instance v1, Lna/p0;

    invoke-virtual {v0}, Lna/t;->T0()Lna/b0;

    move-result-object v4

    invoke-direct {v1, v3, v4}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V

    add-int/2addr p3, v2

    invoke-direct {p0, v1, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;
    ...
    invoke-direct {p0, v2, p2, p3}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;
    ...
    invoke-static {p2}, Lna/r0;->a(Lna/y;)Lna/b0;
    ...
    .line 26
    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/resolve/calls/inference/CapturedTypeConstructorKt;->d(Lna/y;)Z
    ...
    invoke-interface {p3}, Lna/l0;->m()Lkotlin/reflect/jvm/internal/impl/builtins/b;

    move-result-object p3

    invoke-virtual {p3}, Lkotlin/reflect/jvm/internal/impl/builtins/b;->I()Lna/b0;
    ...
    :cond_c
    :goto_1
    invoke-static {v0}, Lna/k0;->a(Lna/y;)Lna/i;
    ...
    invoke-interface {p2, v4}, Lna/i;->I(Lna/y;)Lna/y;
    ...
    invoke-static {p2, v4}, Lna/t0;->r(Lna/y;Z)Lna/y;
    ...
    invoke-interface {v4}, Lb9/e;->isEmpty()Z
    ...
    .line 35
    iget-object v4, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;

    invoke-interface {v0}, Lb9/a;->getAnnotations()Lb9/e;

    move-result-object v0

    invoke-virtual {v4, v0}, Lna/q0;->d(Lb9/e;)Lb9/e;

    move-result-object v0

    invoke-static {v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->i(Lb9/e;)Lb9/e;
    ...
    invoke-direct {v4, p3}, Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/CompositeAnnotations;-><init>([Lb9/e;)V

    invoke-static {p2, v4}, Lkotlin/reflect/jvm/internal/impl/types/typeUtil/TypeUtilsKt;->r(Lna/y;Lb9/e;)Lna/y;

    move-result-object p2

    .line 37
    :cond_f
    sget-object p3, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor$VarianceConflictType;->b:Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor$VarianceConflictType;
    ...
    invoke-static {v3, p1}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->c(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lkotlin/reflect/jvm/internal/impl/types/Variance;
    ...
    invoke-direct {p1, v3, p2}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V

    return-object p1

    .line 39
    :cond_11
    invoke-direct {p0, p1, p3}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->r(Lna/n0;I)Lna/n0;
...
.method public m()Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    ...
    invoke-virtual {v2}, Lna/x;->j()[La9/n0;

    move-result-object v2

    iget-object v3, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->a:Lna/q0;

    check-cast v3, Lna/x;

    invoke-virtual {v3}, Lna/x;->i()[Lna/n0;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {v1, v2, v3, v4}, Lna/x;-><init>([La9/n0;[Lna/n0;Z)V

    invoke-direct {v0, v1}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;-><init>(Lna/q0;)V
...
.method public n(Lna/y;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lna/y;
    .locals 1
    ...
    invoke-direct {v0, p2, p1}, Lna/p0;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lna/y;)V

    const/4 p1, 0x0

    const/4 p2, 0x0

    invoke-direct {p0, v0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;
...
.method public p(Lna/y;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lna/y;
    .locals 2
    ...
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->j()Lna/q0;
    ...
    invoke-virtual {p0, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->q(Lna/n0;)Lna/n0;
...
.method public q(Lna/n0;)Lna/n0;
    ...
    .line 1
    :cond_0
    invoke-virtual {p0, p1}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->t(Lna/n0;)Lna/n0;
    ...
    invoke-static {p1, v0}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/CapturedTypeApproximationKt;->c(Lna/n0;Z)Lna/n0;
...
.method public t(Lna/n0;)Lna/n0;
    ...
    .line 2
    :try_start_0
    invoke-direct {p0, p1, v1, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->u(Lna/n0;La9/n0;I)Lna/n0;
