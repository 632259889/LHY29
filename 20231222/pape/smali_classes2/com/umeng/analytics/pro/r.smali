...
.method private a(Lorg/json/b;Z)V
    .locals 2
...
.method private b()Lorg/json/a;
    ...
    .line 29
    invoke-virtual {v3, v1, v5, v6}, Lorg/json/b;->put(Ljava/lang/String;J)Lorg/json/b;
...
.method public a(Lorg/json/b;Landroid/content/Context;)V
    .locals 4
    ...
    .line 18
    invoke-direct {p0, p1, v2}, Lcom/umeng/analytics/pro/r;->a(Lorg/json/b;Z)V
    ...
    .line 21
    :try_start_0
    invoke-direct {p0}, Lcom/umeng/analytics/pro/r;->b()Lorg/json/a;
    ...
    .line 24
    invoke-direct {p0, p1, v1}, Lcom/umeng/analytics/pro/r;->a(Lorg/json/b;Z)V
...
.method public b(Lorg/json/b;Landroid/content/Context;)V
    .locals 8
    ...
    .line 2
    invoke-virtual {p1, v6}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    .line 3
    invoke-virtual {p1, v6}, Lorg/json/b;->remove(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 8
    invoke-virtual {v6, v1}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    .line 9
    invoke-virtual {v6, v1}, Lorg/json/b;->remove(Ljava/lang/String;)Ljava/lang/Object;

    .line 10
    :cond_1
    invoke-virtual {v6, v0}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    .line 11
    invoke-virtual {v6, v0}, Lorg/json/b;->remove(Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 16
    invoke-virtual {p1, v5}, Lorg/json/b;->remove(Ljava/lang/String;)Ljava/lang/Object;

    .line 17
    :cond_6
    :try_start_1
    invoke-direct {p0}, Lcom/umeng/analytics/pro/r;->c()Lorg/json/a;

    move-result-object v0

    invoke-virtual {p1, v5, v0}, Lorg/json/b;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/b;
    :try_end_1
