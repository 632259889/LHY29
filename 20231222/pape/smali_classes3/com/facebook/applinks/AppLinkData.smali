...
# instance fields
.field private appLinkData:Lorg/json/b;
...
.field private arguments:Lorg/json/b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public static createFromAlApplinkData(Landroid/content/Intent;)Lcom/facebook/applinks/AppLinkData;
    ...
    .line 4
    invoke-static {p0}, Lcom/facebook/applinks/AppLinkData;->getAppLinkData(Landroid/net/Uri;)Lorg/json/b;

    move-result-object p0

    iput-object p0, v4, Lcom/facebook/applinks/AppLinkData;->appLinkData:Lorg/json/b;
    ...
    .line 9
    iput-object v3, v4, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;
...
.method private static createFromJson(Ljava/lang/String;)Lcom/facebook/applinks/AppLinkData;
    ...
    invoke-direct {v9, p0}, Lorg/json/b;-><init>(Ljava/lang/String;)V

    const-string p0, "version"

    .line 2
    invoke-virtual {v9, p0}, Lorg/json/b;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {v9, v10}, Lorg/json/b;->getJSONObject(Ljava/lang/String;)Lorg/json/b;
    ...
    .line 4
    invoke-virtual {v10, v11}, Lorg/json/b;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v9, p0, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;

    .line 8
    invoke-virtual {v9, v6}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    .line 9
    iget-object v3, p0, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;
    ...
    .line 10
    :cond_1
    iget-object v6, p0, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;

    invoke-virtual {v6, v5}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v5}, Lorg/json/b;->getJSONObject(Ljava/lang/String;)Lorg/json/b;

    move-result-object v5

    .line 12
    invoke-virtual {v5, v3}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    .line 13
    invoke-virtual {v5, v3}, Lorg/json/b;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 17
    invoke-static {v3}, Lcom/facebook/applinks/AppLinkData;->getAppLinkData(Landroid/net/Uri;)Lorg/json/b;

    move-result-object v3

    iput-object v3, p0, Lcom/facebook/applinks/AppLinkData;->appLinkData:Lorg/json/b;
    ...
    invoke-virtual {v3, v2}, Lorg/json/b;->getJSONObject(Ljava/lang/String;)Lorg/json/b;
    ...
    .line 24
    :cond_4
    iget-object v0, p0, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;

    invoke-static {v0}, Lcom/facebook/applinks/AppLinkData;->toBundle(Lorg/json/b;)Landroid/os/Bundle;
...
.method private static createFromUri(Landroid/net/Uri;)Lcom/facebook/applinks/AppLinkData;
    ...
    iput-object p0, v0, Lcom/facebook/applinks/AppLinkData;->appLinkData:Lorg/json/b;
...
.method private static fetchDeferredAppLinkFromServer(Landroid/content/Context;Ljava/lang/String;Lcom/facebook/applinks/AppLinkData$CompletionHandler;)V
    ...
    .line 6
    invoke-static {v0, v1, v2, v3, p0}, Lcom/facebook/internal/Utility;->setAppEventAttributionParameters(Lorg/json/b;Lcom/facebook/internal/AttributionIdentifiers;Ljava/lang/String;ZLandroid/content/Context;)V
    ...
    .line 8
    invoke-static {v0, v1}, Lcom/facebook/internal/Utility;->setAppEventExtendedDeviceInfoParameters(Lorg/json/b;Landroid/content/Context;)V
    ...
    .line 11
    :try_start_1
    invoke-static {p1, p0, v0, p1}, Lcom/facebook/GraphRequest;->newPostRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lorg/json/b;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    ...
    .line 15
    invoke-virtual {p0, v1, v2, v3}, Lorg/json/b;->optLong(Ljava/lang/String;J)J
    ...
    .line 20
    :try_start_2
    iget-object v0, p1, Lcom/facebook/applinks/AppLinkData;->arguments:Lorg/json/b;
    :try_end_2
    ...
    .line 21
    :try_start_3
    invoke-virtual {v0, v2, v4, v5}, Lorg/json/b;->put(Ljava/lang/String;J)Lorg/json/b;
...
.method private static getAppLinkData(Landroid/net/Uri;)Lorg/json/b;
    .locals 3
...
.method private static toBundle(Lorg/json/b;)Landroid/os/Bundle;
    .locals 7
    ...
    invoke-static {v3}, Lcom/facebook/applinks/AppLinkData;->toBundle(Lorg/json/b;)Landroid/os/Bundle;
    ...
    .line 16
    invoke-virtual {v3, v5}, Lorg/json/a;->f(I)Lorg/json/b;

    move-result-object v6

    invoke-static {v6}, Lcom/facebook/applinks/AppLinkData;->toBundle(Lorg/json/b;)Landroid/os/Bundle;
...
# virtual methods
.method public getAppLinkData()Lorg/json/b;
    .locals 1

    .line 4
    iget-object v0, p0, Lcom/facebook/applinks/AppLinkData;->appLinkData:Lorg/json/b;
...
.method public isAutoAppLink()Z
    ...
    .line 5
    iget-object v5, p0, Lcom/facebook/applinks/AppLinkData;->appLinkData:Lorg/json/b;

    if-eqz v5, :cond_1

    const-string v6, "is_auto_applink"

    invoke-virtual {v5, v6}, Lorg/json/b;->optBoolean(Ljava/lang/String;)Z
