...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/unity3d/services/core/configuration/Configuration;->setOptionalFields(Lorg/json/b;Z)V
...
.method public constructor <init>(Lorg/json/b;)V
    ...
    .line 9
    invoke-virtual {p0, p1, v0}, Lcom/unity3d/services/core/configuration/Configuration;->handleConfigurationData(Lorg/json/b;Z)V
...
.method private getFilteredConfigJson(Lorg/json/b;)Lorg/json/b;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
...
.method private setOptionalFields(Lorg/json/b;Z)V
    .locals 7
    ...
    .line 2
    invoke-virtual {p1, v0, v2}, Lorg/json/b;->optBoolean(Ljava/lang/String;Z)Z
    ...
    .line 5
    invoke-virtual {p1, v0, v3, v4}, Lorg/json/b;->optLong(Ljava/lang/String;J)J
    ...
    .line 6
    invoke-virtual {p1, v0, v3, v4}, Lorg/json/b;->optDouble(Ljava/lang/String;D)D
    ...
    .line 10
    invoke-virtual {p1, v0, v5}, Lorg/json/b;->optString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 15
    invoke-virtual {p1, v0, v5, v6}, Lorg/json/b;->optDouble(Ljava/lang/String;D)D
    ...
    invoke-direct {v1, p1}, Lcom/unity3d/services/core/configuration/ExperimentObjects;-><init>(Lorg/json/b;)V
    ...
    invoke-direct {v1, p1}, Lcom/unity3d/services/core/configuration/Experiments;-><init>(Lorg/json/b;)V
...
.method protected handleConfigurationData(Lorg/json/b;Z)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/net/MalformedURLException;,
    ...
    .line 8
    invoke-direct {p0, p1, p2}, Lcom/unity3d/services/core/configuration/Configuration;->setOptionalFields(Lorg/json/b;Z)V

    .line 9
    invoke-direct {p0, p1}, Lcom/unity3d/services/core/configuration/Configuration;->getFilteredConfigJson(Lorg/json/b;)Lorg/json/b;
...
.method protected makeRequest()V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/unity3d/services/core/configuration/Configuration;->handleConfigurationData(Lorg/json/b;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
