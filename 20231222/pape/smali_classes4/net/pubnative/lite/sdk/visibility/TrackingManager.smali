...
.method protected static getList(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p1, p0}, Lorg/json/a;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lorg/json/a;->f(I)Lorg/json/b;

    move-result-object v2

    invoke-direct {v1, v2}, Lnet/pubnative/lite/sdk/models/TrackingUrlModel;-><init>(Lorg/json/b;)V
...
.method protected static setList(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 6
    :try_start_0
    invoke-virtual {v1}, Lnet/pubnative/lite/sdk/utils/json/JsonModel;->toJson()Lorg/json/b;
