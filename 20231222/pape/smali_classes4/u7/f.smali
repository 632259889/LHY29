...
.method public constructor <init>(Leyewind/drawboard/drawpad/DrawingView;)V
    ...
    iput-object p1, p0, Lu7/f;->n:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lu7/f;->t:Ljava/util/ArrayList;

    const/high16 p1, 0x40000000    # 2.0f

    .line 4
    iput p1, p0, Lu7/f;->u:F

    const/high16 p1, 0x41200000    # 10.0f

    .line 5
    iput p1, p0, Lu7/f;->v:F

    const/4 p1, 0x5

    .line 6
    iput p1, p0, Lu7/f;->w:I

    const p1, 0x3dcccccd    # 0.1f

    .line 7
    iput p1, p0, Lu7/f;->x:F
    ...
    iput-object p1, p0, Lu7/f;->p:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lu7/f;->q:Landroid/graphics/Bitmap;

    .line 10
    new-instance p1, Landroid/graphics/Canvas;

    iget-object v0, p0, Lu7/f;->q:Landroid/graphics/Bitmap;

    invoke-direct {p1, v0}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    iput-object p1, p0, Lu7/f;->r:Landroid/graphics/Canvas;
    ...
    iput-object p1, p0, Lu7/f;->s:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lu7/f;->D:Landroid/graphics/Paint;

    .line 15
    iget-object p1, p0, Lu7/f;->n:Landroid/graphics/Paint;
    ...
    .line 21
    iget-object p1, p0, Lu7/f;->D:Landroid/graphics/Paint;
...
.method private u(Landroid/graphics/Canvas;Leyewind/drawboard/k;Leyewind/drawboard/k;Leyewind/drawboard/k;Landroid/graphics/Paint;FF)V
    ...
    invoke-direct {p0, v2, v3, v1}, Lu7/f;->w(FFF)F
    ...
    invoke-direct {p0, v3, v4, v1}, Lu7/f;->w(FFF)F
    ...
    invoke-direct {p0, v4, v5, v1}, Lu7/f;->w(FFF)F
    ...
    invoke-direct {p0, v5, v6, v1}, Lu7/f;->w(FFF)F

    move-result v5

    .line 5
    invoke-direct {p0, v2, v4, v1}, Lu7/f;->w(FFF)F

    move-result v2

    .line 6
    invoke-direct {p0, v3, v5, v1}, Lu7/f;->w(FFF)F
...
.method private v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
    ...
    .line 1
    iget-object v0, p0, Lu7/f;->y:Leyewind/drawboard/k;

    iget-object v1, p0, Lu7/f;->z:Leyewind/drawboard/k;

    invoke-direct {p0, v0, v1}, Lu7/f;->y(Leyewind/drawboard/k;Leyewind/drawboard/k;)Leyewind/drawboard/k;

    move-result-object v4

    .line 2
    iget-object v0, p0, Lu7/f;->A:Leyewind/drawboard/k;

    iget-object v1, p0, Lu7/f;->y:Leyewind/drawboard/k;
    ...
    .line 3
    iget-object v5, p0, Lu7/f;->y:Leyewind/drawboard/k;
    ...
    invoke-direct/range {v2 .. v9}, Lu7/f;->u(Landroid/graphics/Canvas;Leyewind/drawboard/k;Leyewind/drawboard/k;Leyewind/drawboard/k;Landroid/graphics/Paint;FF)V
...
.method public b(Landroid/graphics/Canvas;Leyewind/drawboard/k;)Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lu7/f;->z:Leyewind/drawboard/k;

    .line 2
    iget-object v0, p0, Lu7/f;->A:Leyewind/drawboard/k;

    iput-object v0, p0, Lu7/f;->y:Leyewind/drawboard/k;
    ...
    iput-object v3, p0, Lu7/f;->A:Leyewind/drawboard/k;

    .line 7
    iget-object p2, p0, Lu7/f;->y:Leyewind/drawboard/k;

    invoke-virtual {v3, p2}, Leyewind/drawboard/k;->h(Leyewind/drawboard/k;)F
    ...
    .line 11
    :goto_0
    iget p2, p0, Lu7/f;->x:F

    mul-float v1, v1, p2

    sub-float/2addr v4, p2

    iget p2, p0, Lu7/f;->B:F
    ...
    .line 12
    invoke-direct {p0, v1}, Lu7/f;->x(F)F
    ...
    .line 14
    :cond_3
    iget-object v0, p0, Lu7/f;->r:Landroid/graphics/Canvas;

    iget-object v2, p0, Lu7/f;->n:Landroid/graphics/Paint;

    iget v3, p0, Lu7/f;->C:F

    invoke-direct {p0, v0, v2, v3, p2}, Lu7/f;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V

    .line 15
    iput v1, p0, Lu7/f;->B:F

    .line 16
    iput p2, p0, Lu7/f;->C:F
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lu7/f;->t()Lu7/b;
...
.method public d(Landroid/graphics/Canvas;Leyewind/drawboard/k;)Landroid/graphics/Rect;
    ...
    .line 1
    iget-object p1, p0, Lu7/f;->y:Leyewind/drawboard/k;

    iput-object p1, p0, Lu7/f;->z:Leyewind/drawboard/k;

    .line 2
    iget-object p1, p0, Lu7/f;->A:Leyewind/drawboard/k;

    iput-object p1, p0, Lu7/f;->y:Leyewind/drawboard/k;
    ...
    iput-object v2, p0, Lu7/f;->A:Leyewind/drawboard/k;

    .line 7
    iget-object p1, p0, Lu7/f;->r:Landroid/graphics/Canvas;

    iget-object p2, p0, Lu7/f;->n:Landroid/graphics/Paint;

    iget v0, p0, Lu7/f;->C:F

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v0, v1}, Lu7/f;->v(Landroid/graphics/Canvas;Landroid/graphics/Paint;FF)V
...
.method public s(FFJ)V
    ...
    .line 1
    iget-object v0, p0, Lu7/f;->n:Landroid/graphics/Paint;
    ...
    iput v0, p0, Lu7/f;->x:F

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Lu7/f;->o:Leyewind/drawboard/k;

    .line 6
    iget-object v0, p0, Lu7/f;->s:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 7
    iget-object v0, p0, Lu7/f;->t:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 8
    iget-object v0, p0, Lu7/f;->p:Landroid/graphics/Path;
    ...
    .line 13
    iput-object v3, p0, Lu7/f;->y:Leyewind/drawboard/k;

    .line 14
    iput-object v3, p0, Lu7/f;->z:Leyewind/drawboard/k;

    const/4 p1, 0x0

    .line 15
    iput p1, p0, Lu7/f;->B:F

    .line 16
    invoke-direct {p0, p1}, Lu7/f;->x(F)F

    move-result p1

    iput p1, p0, Lu7/f;->C:F
