...
.method public commit(Ljava/lang/String;Lcom/facebook/binaryresource/FileBinaryResource;Ljava/lang/Object;)Lcom/facebook/binaryresource/FileBinaryResource;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :try_start_0
    invoke-static {p2, p1}, Lcom/facebook/common/file/FileUtils;->rename(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    ...
    .line 14
    :goto_0
    iget-object p3, p0, Lcom/facebook/cache/disk/DefaultDiskStorage;->mCacheErrorLogger:Lcom/facebook/cache/common/CacheErrorLogger;
...
.method public createTemporary(Ljava/lang/String;Ljava/lang/Object;)Lcom/facebook/binaryresource/FileBinaryResource;
    ...
    .line 2
    iget-object p1, p2, Lcom/facebook/cache/disk/DefaultDiskStorage$FileInfo;->resourceId:Ljava/lang/String;

    invoke-direct {p0, p1}, Lcom/facebook/cache/disk/DefaultDiskStorage;->getSubdirectory(Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v1, "createTemporary"

    if-nez v0, :cond_0

    .line 4
    invoke-direct {p0, p1, v1}, Lcom/facebook/cache/disk/DefaultDiskStorage;->mkdirs(Ljava/io/File;Ljava/lang/String;)V

    .line 5
    :cond_0
    :try_start_0
    invoke-virtual {p2, p1}, Lcom/facebook/cache/disk/DefaultDiskStorage$FileInfo;->createTempFile(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-interface {p2, v0, v2, v1, p1}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method getContentFileFor(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, p1}, Lcom/facebook/cache/disk/DefaultDiskStorage;->getFilename(Ljava/lang/String;)Ljava/lang/String;
...
.method public updateResource(Ljava/lang/String;Lcom/facebook/binaryresource/FileBinaryResource;Lcom/facebook/cache/common/WriterCallback;Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :try_start_1
    new-instance p4, Lcom/facebook/common/internal/CountingOutputStream;

    invoke-direct {p4, p2}, Lcom/facebook/common/internal/CountingOutputStream;-><init>(Ljava/io/OutputStream;)V

    .line 4
    invoke-interface {p3, p4}, Lcom/facebook/cache/common/WriterCallback;->write(Ljava/io/OutputStream;)V

    .line 5
    invoke-virtual {p4}, Ljava/io/FilterOutputStream;->flush()V

    .line 6
    invoke-virtual {p4}, Lcom/facebook/common/internal/CountingOutputStream;->getCount()J
    ...
    .line 9
    :cond_0
    new-instance p2, Lcom/facebook/cache/disk/DefaultDiskStorage$IncompleteFileException;

    invoke-virtual {p1}, Ljava/io/File;->length()J

    move-result-wide v0

    invoke-direct {p2, p3, p4, v0, v1}, Lcom/facebook/cache/disk/DefaultDiskStorage$IncompleteFileException;-><init>(JJ)V
    ...
    sget-object p3, Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;->WRITE_UPDATE_FILE_NOT_FOUND:Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;

    sget-object p4, Lcom/facebook/cache/disk/DefaultDiskStorage;->TAG:Ljava/lang/Class;

    const-string v0, "updateResource"

    invoke-interface {p2, p3, p4, v0, p1}, Lcom/facebook/cache/common/CacheErrorLogger;->logError(Lcom/facebook/cache/common/CacheErrorLogger$CacheErrorCategory;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
