...
.method private static a(Lorg/json/b;)Lcom/iab/omid/library/applovin/utils/c$b;
    .locals 13
    ...
    invoke-virtual {v4, v5}, Lorg/json/b;->optDouble(Ljava/lang/String;)D

    move-result-wide v5

    const-string v7, "y"

    invoke-virtual {v4, v7}, Lorg/json/b;->optDouble(Ljava/lang/String;)D

    move-result-wide v7

    const-string v9, "width"

    invoke-virtual {v4, v9}, Lorg/json/b;->optDouble(Ljava/lang/String;)D

    move-result-wide v9

    const-string v11, "height"

    invoke-virtual {v4, v11}, Lorg/json/b;->optDouble(Ljava/lang/String;)D
...
.method public static a(Lorg/json/b;Lcom/iab/omid/library/applovin/adsession/OutputDeviceStatus;)V
    .locals 1
...
.method public static a(Lorg/json/b;Lcom/iab/omid/library/applovin/walking/a$a;)V
    .locals 3
    ...
    invoke-virtual {p0, p1, v1}, Lorg/json/b;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/b;
...
.method public static a(Lorg/json/b;Ljava/lang/Boolean;)V
    .locals 1
...
.method public static a(Lorg/json/b;Ljava/lang/String;)V
    .locals 1
...
.method private static a(Lorg/json/a;Lorg/json/a;)Z
    .locals 2
...
.method public static b(Lorg/json/b;)V
    .locals 4

    invoke-static {p0}, Lcom/iab/omid/library/applovin/utils/c;->a(Lorg/json/b;)Lcom/iab/omid/library/applovin/utils/c$b;
    ...
    invoke-virtual {p0, v1, v2, v3}, Lorg/json/b;->put(Ljava/lang/String;D)Lorg/json/b;
...
.method public static b(Lorg/json/b;Ljava/lang/String;)V
    .locals 1
...
.method private static b(Lorg/json/b;Lorg/json/b;)Z
    .locals 5
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->a(Lorg/json/a;Lorg/json/a;)Z
    ...
    invoke-static {v3, v4}, Lcom/iab/omid/library/applovin/utils/c;->h(Lorg/json/b;Lorg/json/b;)Z
...
.method private static c(Lorg/json/b;Lorg/json/b;)Z
    .locals 5
    ...
    invoke-virtual {p0, v1, v3}, Lorg/json/a;->x(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v1, v3}, Lorg/json/a;->x(ILjava/lang/String;)Ljava/lang/String;
...
.method private static d(Lorg/json/b;Lorg/json/b;)Z
    .locals 1

    const-string v0, "hasWindowFocus"

    invoke-virtual {p0, v0}, Lorg/json/b;->optBoolean(Ljava/lang/String;)Z
...
.method private static e(Lorg/json/b;Lorg/json/b;)Z
    .locals 1
...
.method private static f(Lorg/json/b;Lorg/json/b;)Z
    .locals 9
    ...
    invoke-virtual {p0, v4}, Lorg/json/b;->optDouble(Ljava/lang/String;)D

    move-result-wide v5

    invoke-virtual {p1, v4}, Lorg/json/b;->optDouble(Ljava/lang/String;)D
...
.method private static g(Lorg/json/b;Lorg/json/b;)Z
    .locals 2
...
.method public static h(Lorg/json/b;Lorg/json/b;)Z
    .locals 3
    ...
    :cond_1
    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->f(Lorg/json/b;Lorg/json/b;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->g(Lorg/json/b;Lorg/json/b;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->e(Lorg/json/b;Lorg/json/b;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->d(Lorg/json/b;Lorg/json/b;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->c(Lorg/json/b;Lorg/json/b;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lcom/iab/omid/library/applovin/utils/c;->b(Lorg/json/b;Lorg/json/b;)Z
