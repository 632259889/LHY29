...
.field final synthetic val$stagedObject:Lorg/json/a;


# direct methods
.method constructor <init>(Lcom/facebook/share/ShareApi;Ljava/util/ArrayList;Lorg/json/a;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/facebook/share/ShareApi$3;->val$stagedObject:Lorg/json/a;
...
.method public set(Ljava/lang/Integer;Ljava/lang/Object;Lcom/facebook/internal/CollectionMapper$OnErrorListener;)V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lcom/facebook/share/ShareApi$3;->val$stagedObject:Lorg/json/a;

    invoke-virtual {p1}, Ljava/lang/Integer;->intValue()I

    move-result p1

    invoke-virtual {v0, p1, p2}, Lorg/json/a;->C(ILjava/lang/Object;)Lorg/json/a;
    :try_end_0
