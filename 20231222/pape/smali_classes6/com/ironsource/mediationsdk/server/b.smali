...
.method public constructor <init>(Lorg/json/b;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/ironsource/mediationsdk/server/b;-><init>(Lorg/json/b;Lorg/json/b;)V
...
.method public constructor <init>(Lorg/json/b;Lorg/json/b;)V
    ...
    :try_start_0
    invoke-virtual {p1, v8}, Lorg/json/b;->has(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_0

    invoke-virtual {p1, v8}, Lorg/json/b;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1, v7}, Lorg/json/b;->has(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v1}, Lorg/json/b;->getJSONArray(Ljava/lang/String;)Lorg/json/a;
    ...
    invoke-virtual {v4, v0}, Lorg/json/b;->getJSONArray(Ljava/lang/String;)Lorg/json/a;
    ...
    invoke-static {v1}, Lcom/ironsource/mediationsdk/c/b;->a([Lorg/json/b;)Lorg/json/b;

    move-result-object v0

    invoke-direct {p1, v0}, Lcom/ironsource/mediationsdk/impressionData/ImpressionData;-><init>(Lorg/json/b;)V
