...
.method private final c(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/k;)Z
    .locals 3
    ...
    .line 2
    invoke-interface {v0, p2}, Lqa/m;->B(Lqa/g;)Z
    ...
    invoke-interface {v0, p2}, Lqa/m;->e0(Lqa/h;)Z
...
.method private final e(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/h;)Z
    .locals 4
    ...
    .line 2
    sget-boolean v1, Lna/f;->b:Z

    if-eqz v1, :cond_1

    .line 3
    invoke-interface {v0, p2}, Lqa/m;->c(Lqa/h;)Z
    ...
    invoke-interface {v0, v1}, Lqa/m;->W(Lqa/k;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;->m(Lqa/g;)Z

    move-result v1

    .line 4
    :cond_0
    invoke-interface {v0, p3}, Lqa/m;->c(Lqa/h;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {p1, p3}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;->m(Lqa/g;)Z

    move-result v1

    .line 5
    :cond_1
    invoke-interface {v0, p3}, Lqa/m;->L(Lqa/h;)Z
    ...
    .line 6
    :cond_2
    invoke-interface {v0, p2}, Lqa/m;->R(Lqa/g;)Z
    ...
    invoke-interface {v0, v1}, Lqa/m;->D(Lqa/b;)Z
    ...
    invoke-virtual {v1, p1, p2, v3}, Lna/c;->a(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext$a;)Z
    ...
    .line 9
    :cond_5
    invoke-interface {v0, p3}, Lqa/m;->R(Lqa/g;)Z
    ...
    invoke-virtual {v1, p1, p3, v2}, Lna/c;->a(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext$a;)Z
    ...
    .line 12
    :cond_8
    invoke-interface {v0, p3}, Lqa/m;->e(Lqa/h;)Lqa/k;

    move-result-object p3

    invoke-virtual {v1, p1, p2, p3}, Lna/c;->b(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/k;)Z
...
# virtual methods
.method public final a(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext$a;)Z
    .locals 16
    ...
    .line 2
    invoke-interface {v2, v1}, Lqa/m;->u(Lqa/h;)Z
    ...
    invoke-interface {v2, v1}, Lqa/m;->L(Lqa/h;)Z
    ...
    :cond_0
    invoke-interface {v2, v1}, Lqa/m;->R(Lqa/g;)Z
    ...
    .line 11
    :cond_5
    invoke-interface {v2, v8}, Lqa/m;->L(Lqa/h;)Z
    ...
    invoke-interface {v10, v8}, Lqa/m;->e(Lqa/h;)Lqa/k;

    move-result-object v8

    invoke-interface {v10, v8}, Lqa/m;->n(Lqa/k;)Ljava/util/Collection;
    ...
    check-cast v10, Lqa/g;

    .line 15
    invoke-virtual {v9, v0, v10}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext$a;->a(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/g;)Lqa/h;

    move-result-object v10

    .line 16
    invoke-interface {v2, v10}, Lqa/m;->u(Lqa/h;)Z

    move-result v11

    if-eqz v11, :cond_9

    invoke-interface {v2, v10}, Lqa/m;->L(Lqa/h;)Z
    ...
    :cond_9
    invoke-interface {v2, v10}, Lqa/m;->R(Lqa/g;)Z
    ...
    invoke-static/range {v7 .. v15}, Lkotlin/collections/h;->g0(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Ll8/l;ILjava/lang/Object;)Ljava/lang/String;
...
.method public final b(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/k;)Z
    .locals 12
    ...
    invoke-direct {v1, p1, p2, p3}, Lna/c;->c(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/k;)Z
    ...
    .line 16
    sget-object v7, Lna/c;->a:Lna/c;

    invoke-direct {v7, p1, v6, p3}, Lna/c;->c(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/k;)Z
...
.method public final d(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/h;)Z
    .locals 1
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3}, Lna/c;->e(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeCheckerContext;Lqa/h;Lqa/h;)Z
