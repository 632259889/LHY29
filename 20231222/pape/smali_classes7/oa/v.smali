...
# direct methods
.method private static final a(Lna/y;)Lna/y;
    .locals 0

    .line 1
    invoke-static {p0}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/CapturedTypeApproximationKt;->a(Lna/y;)Lra/a;
...
.method private static final b(Lna/l0;)Ljava/lang/String;
    .locals 4
    ...
    invoke-static {v1, v0}, Loa/v;->c(Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v1, p0}, Lkotlin/reflect/jvm/internal/impl/renderer/DescriptorRenderer;->q(La9/h;)Ljava/lang/String;
...
.method public static final d(Lna/y;Lna/y;Loa/u;)Lna/y;
    .locals 9
    ...
    invoke-direct {v1, p0, v2}, Loa/r;-><init>(Lna/y;Loa/r;)V
    ...
    .line 6
    invoke-virtual {p1}, Loa/r;->b()Lna/y;
    ...
    .line 8
    invoke-interface {p2, v3, p0}, Loa/u;->a(Lna/l0;Lna/l0;)Z
    ...
    .line 10
    invoke-virtual {p1}, Loa/r;->a()Loa/r;
    ...
    .line 12
    invoke-virtual {v3}, Lna/y;->K0()Ljava/util/List;
    ...
    .line 16
    sget-object v4, Lna/m0;->c:Lna/m0$a;

    invoke-virtual {v4, v3}, Lna/m0$a;->a(Lna/y;)Lna/q0;

    move-result-object v4

    .line 17
    invoke-static {v4, v7, v6, v2}, Lkotlin/reflect/jvm/internal/impl/resolve/calls/inference/CapturedTypeConstructorKt;->f(Lna/q0;ZILjava/lang/Object;)Lna/q0;

    move-result-object v4

    invoke-virtual {v4}, Lna/q0;->c()Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    ...
    invoke-virtual {v4, v1, v5}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->n(Lna/y;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lna/y;
    ...
    .line 19
    invoke-static {v1}, Loa/v;->a(Lna/y;)Lna/y;
    ...
    .line 27
    invoke-interface {p2, p1, p0}, Loa/u;->a(Lna/l0;Lna/l0;)Z
    ...
    .line 28
    invoke-static {v1, v0}, Lna/t0;->q(Lna/y;Z)Lna/y;
    ...
    .line 30
    invoke-static {p1}, Loa/v;->b(Lna/l0;)Ljava/lang/String;
    ...
    .line 32
    invoke-static {p0}, Loa/v;->b(Lna/l0;)Ljava/lang/String;
    ...
    invoke-direct {v4, v3, p1}, Loa/r;-><init>(Lna/y;Loa/r;)V
