...
.method public setProvider(Li0;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->mProvider:Li0;
...
.method public showPopupUnchecked(I)V
    ...
    .line 18
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->mProvider:Li0;

    if-eqz v0, :cond_4

    .line 19
    invoke-virtual {v0, v1}, Li0;->subUiVisibilityChanged(Z)V
