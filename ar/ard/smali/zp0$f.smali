...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    .line 2
    iput-object p1, p0, Lzp0$f;->a:Landroid/view/ActionMode$Callback;

    .line 3
    iput-object p2, p0, Lzp0$f;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    .line 4
    iput-boolean p1, p0, Lzp0$f;->f:Z
...
.method public final b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    .line 1
    invoke-virtual {p0}, Lzp0$f;->a()Landroid/content/Intent;

    move-result-object v0

    .line 2
    invoke-virtual {p0, p2}, Lzp0$f;->e(Landroid/widget/TextView;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 5
    invoke-virtual {p0, v1, p1}, Lzp0$f;->f(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public d()Landroid/view/ActionMode$Callback;
    ...
    .line 1
    iget-object v0, p0, Lzp0$f;->a:Landroid/view/ActionMode$Callback;
...
.method public final g(Landroid/view/Menu;)V
    ...
    .line 1
    iget-object v0, p0, Lzp0$f;->b:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lzp0$f;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Lzp0$f;->d:Ljava/lang/reflect/Method;

    .line 8
    iput-boolean v5, p0, Lzp0$f;->e:Z
    :try_end_0
    ...
    .line 11
    iput-boolean v4, p0, Lzp0$f;->e:Z

    .line 12
    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Lzp0$f;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Lzp0$f;->c:Ljava/lang/Class;
    ...
    .line 13
    iget-object v2, p0, Lzp0$f;->d:Ljava/lang/reflect/Method;
    ...
    .line 21
    :cond_3
    invoke-virtual {p0, v0, v1}, Lzp0$f;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Lzp0$f;->b:Landroid/widget/TextView;

    .line 26
    invoke-virtual {p0, v3, v7}, Lzp0$f;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, Lzp0$f;->g(Landroid/view/Menu;)V
