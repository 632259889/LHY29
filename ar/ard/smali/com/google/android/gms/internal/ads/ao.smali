...
.method public constructor <init>(Lxm4;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/ao;->a:Lxm4;

    iput-object p2, p0, Lcom/google/android/gms/internal/ads/ao;->b:Landroid/content/Context;
...
# virtual methods
.method public final synthetic a()Lcom/google/android/gms/internal/ads/zn;
    .locals 22
    ...
    .line 1
    iget-object v1, v0, Lcom/google/android/gms/internal/ads/ao;->b:Landroid/content/Context;
    ...
    .line 3
    invoke-static {v1, v3}, Lcom/google/android/gms/internal/ads/ao;->b(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
    ...
    .line 4
    invoke-static {v1, v4}, Lcom/google/android/gms/internal/ads/ao;->b(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
    ...
    .line 8
    invoke-static {v5}, Lei;->c(Landroid/content/Context;)Z
    ...
    .line 9
    invoke-static {v5}, Lei;->d(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v2, v0, Lcom/google/android/gms/internal/ads/ao;->b:Landroid/content/Context;

    const-string v6, "market://details?id=com.google.android.gms.ads"

    .line 15
    invoke-static {v1, v6}, Lcom/google/android/gms/internal/ads/ao;->b(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
    ...
    :cond_3
    :try_start_0
    invoke-static {v2}, Lfy0;->a(Landroid/content/Context;)Lm90;

    move-result-object v2

    iget-object v15, v6, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v2, v15, v5}, Lm90;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    .line 19
    :goto_2
    iget-object v6, v0, Lcom/google/android/gms/internal/ads/ao;->b:Landroid/content/Context;

    .line 20
    :try_start_1
    invoke-static {v6}, Lfy0;->a(Landroid/content/Context;)Lm90;
    ...
    .line 21
    invoke-virtual {v6, v15, v14}, Lm90;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    .line 31
    invoke-static {v6}, Lp35;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct/range {v5 .. v21}, Lcom/google/android/gms/internal/ads/zn;-><init>(ZZLjava/lang/String;ZZZLjava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;JZ)V
...
.method public final zzb()Lwm4;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/ao;->a:Lxm4;

    new-instance v1, Lbx3;

    invoke-direct {v1, p0}, Lbx3;-><init>(Lcom/google/android/gms/internal/ads/ao;)V
