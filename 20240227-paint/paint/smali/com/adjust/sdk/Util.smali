...
.method public static convertToHex([B)Ljava/lang/String;
    ...
    .line 17
    .line 18
    invoke-static {v2, p0, v3}, Lb0/d;->f(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
...
.method public static getConnectivityType(Landroid/content/Context;)I
    ...
    :cond_1
    invoke-static {p0}, Landroidx/appcompat/widget/s;->j(Landroid/net/ConnectivityManager;)Landroid/net/Network;
...
.method public static getLocale(Landroid/content/res/Configuration;)Ljava/util/Locale;
    ...
    invoke-static {v2}, Landroidx/appcompat/widget/f0;->l(Landroid/os/LocaleList;)Z

    move-result v3

    if-nez v3, :cond_0

    invoke-static {v2}, Landroidx/emoji2/text/p;->e(Landroid/os/LocaleList;)Ljava/util/Locale;
