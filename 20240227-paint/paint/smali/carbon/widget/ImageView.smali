...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcarbon/widget/ImageView;->F:[I
    ...
    sput-object v2, Lcarbon/widget/ImageView;->G:[I
    ...
    sput-object v3, Lcarbon/widget/ImageView;->H:[I
    ...
    sput-object v1, Lcarbon/widget/ImageView;->L:[I

    new-array v0, v0, [I

    fill-array-data v0, :array_7

    sput-object v0, Lcarbon/widget/ImageView;->M:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->d:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lcarbon/widget/ImageView;->e:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->i:Loa/i;

    new-instance p1, Loa/f;

    iget-object v1, p0, Lcarbon/widget/ImageView;->i:Loa/i;

    invoke-direct {p1, v1}, Loa/f;-><init>(Loa/i;)V

    iput-object p1, p0, Lcarbon/widget/ImageView;->j:Loa/f;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lcarbon/widget/ImageView;->m:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lcarbon/widget/ImageView;->n:Landroid/graphics/RectF;

    new-instance p1, Lq3/p;

    invoke-direct {p1, p0}, Lq3/p;-><init>(Lq3/n;)V

    iput-object p1, p0, Lcarbon/widget/ImageView;->o:Lq3/p;

    const/4 p1, 0x0

    iput-object p1, p0, Lcarbon/widget/ImageView;->p:Landroid/animation/Animator;
    ...
    invoke-direct {p1, p0, v1}, La4/v;-><init>(Lcarbon/widget/ImageView;I)V

    iput-object p1, p0, Lcarbon/widget/ImageView;->x:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput p1, p0, Lcarbon/widget/ImageView;->C:I
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->E:Ljava/util/ArrayList;

    invoke-virtual {p0, p2, v0}, Lcarbon/widget/ImageView;->j(Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->i:Loa/i;
    ...
    invoke-direct {p1, p0, v0}, La4/v;-><init>(Lcarbon/widget/ImageView;I)V
    ...
    invoke-direct {p1, v1, v0}, La4/w;-><init>(Lcarbon/widget/FloatingActionButton;I)V
    ...
    invoke-virtual {p0, p2, p3}, Lcarbon/widget/ImageView;->j(Landroid/util/AttributeSet;I)V

    return-void
.end method

.method public static c(Lcarbon/widget/ImageView;)V
    .locals 5
    ...
    .line 16
    .line 17
    iget-object v1, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
    ...
    .line 20
    .line 21
    iget-object v1, p0, Lcarbon/widget/ImageView;->v:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 26
    .line 27
    iget-object v2, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
    ...
    .line 33
    iget-object v4, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
    ...
    .line 43
    iget-object v3, p0, Lcarbon/widget/ImageView;->v:Landroid/graphics/PorterDuff$Mode;
...
.method public static e(Lcarbon/widget/ImageView;)V
    .locals 5
    ...
    .line 6
    .line 7
    iget-object v1, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;
    ...
    .line 10
    .line 11
    iget-object v1, p0, Lcarbon/widget/ImageView;->t:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 16
    .line 17
    iget-object v2, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;
    ...
    .line 23
    iget-object v4, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;
    ...
    .line 33
    iget-object v3, p0, Lcarbon/widget/ImageView;->t:Landroid/graphics/PorterDuff$Mode;
...
.method public final a(Landroid/graphics/Canvas;)V
    ...
    .line 78
    :cond_2
    iget-object v2, p0, Lcarbon/widget/ImageView;->c:Landroid/graphics/Paint;
    ...
    .line 119
    :goto_1
    iget-object v1, p0, Lcarbon/widget/ImageView;->j:Loa/f;
    ...
    .line 136
    iget-object v7, p0, Lcarbon/widget/ImageView;->l:Landroid/content/res/ColorStateList;
    ...
    .line 229
    .line 230
    iget-object v1, p0, Lcarbon/widget/ImageView;->e:Landroid/graphics/Path;
...
.method public final b(I)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object v0, p0, Lcarbon/widget/ImageView;->p:Landroid/animation/Animator;

    if-eqz v0, :cond_6

    iput-object v0, p0, Lcarbon/widget/ImageView;->r:Landroid/animation/Animator;

    new-instance v1, Lcarbon/widget/ImageView$b;

    invoke-direct {v1, p0}, Lcarbon/widget/ImageView$b;-><init>(Lcarbon/widget/ImageView;)V
    ...
    new-instance v1, Lcarbon/widget/ImageView$c;

    invoke-direct {v1, p0, p1}, Lcarbon/widget/ImageView$c;-><init>(Lcarbon/widget/ImageView;I)V

    invoke-virtual {v0, v1}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p1, p0, Lcarbon/widget/ImageView;->r:Landroid/animation/Animator;
...
.method public final d(IIII)V
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->m:Landroid/graphics/Rect;
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->j:Loa/f;
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/ImageView;->f:Lw3/i;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lcarbon/widget/ImageView;->d:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lcarbon/widget/ImageView;->l:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Lcarbon/widget/ImageView;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-super {p0, v2}, Landroid/widget/ImageView;->setOutlineSpotShadowColor(I)V

    :cond_0
    iget-object v2, p0, Lcarbon/widget/ImageView;->k:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Lcarbon/widget/ImageView;->k:Landroid/content/res/ColorStateList;
    ...
    invoke-super {p0, v2}, Landroid/widget/ImageView;->setOutlineAmbientShadowColor(I)V
    ...
    iget-object v3, p0, Lcarbon/widget/ImageView;->e:Landroid/graphics/Path;

    iget-object v4, p0, Lcarbon/widget/ImageView;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, v1}, Lcarbon/widget/ImageView;->h(Landroid/graphics/Canvas;)V
    ...
    :cond_6
    iget-object v2, p0, Lcarbon/widget/ImageView;->i:Loa/i;
    ...
    invoke-virtual {p0, p1}, Lcarbon/widget/ImageView;->h(Landroid/graphics/Canvas;)V
...
.method public final drawableStateChanged()V
    ...
    :cond_0
    iget-object v0, p0, Lcarbon/widget/ImageView;->o:Lq3/p;
    ...
    :cond_1
    iget-object v0, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;
    ...
    :cond_2
    iget-object v0, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
...
.method public final f()V
    ...
    iget-object v2, p0, Lcarbon/widget/ImageView;->v:Landroid/graphics/PorterDuff$Mode;
...
.method public final g()V
    ...
    iget-object v2, p0, Lcarbon/widget/ImageView;->t:Landroid/graphics/PorterDuff$Mode;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->v:Landroid/graphics/PorterDuff$Mode;
...
.method public getElevationShadowColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->k:Landroid/content/res/ColorStateList;
...
.method public final getHitRect(Landroid/graphics/Rect;)V
    ...
    iget-object v3, p0, Lcarbon/widget/ImageView;->n:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lcarbon/widget/ImageView;->m:Landroid/graphics/Rect;
...
.method public getMaxWidth()I
    ...
    iget v0, p0, Lcarbon/widget/ImageView;->C:I
...
.method public getStroke()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->z:Landroid/content/res/ColorStateList;
...
.method public getStrokeWidth()F
    ...
    iget v0, p0, Lcarbon/widget/ImageView;->A:F
...
.method public getTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->t:Landroid/graphics/PorterDuff$Mode;
...
.method public final h(Landroid/graphics/Canvas;)V
    ...
    .line 7
    .line 8
    iget-object v0, p0, Lcarbon/widget/ImageView;->B:Landroid/graphics/Paint;

    .line 9
    .line 10
    iget v1, p0, Lcarbon/widget/ImageView;->A:F
    ...
    .line 20
    .line 21
    iget-object v1, p0, Lcarbon/widget/ImageView;->z:Landroid/content/res/ColorStateList;
    ...
    .line 27
    iget-object v3, p0, Lcarbon/widget/ImageView;->z:Landroid/content/res/ColorStateList;
...
.method public final i()V
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->E:Ljava/util/ArrayList;
...
.method public final invalidate()V
    ...
    invoke-virtual {p0}, Lcarbon/widget/ImageView;->k()V
...
.method public final j(Landroid/util/AttributeSet;I)V
    ...
    .line 18
    .line 19
    invoke-static {p0, p1, p2, v0}, Lp3/c;->e(Landroid/view/View;Landroid/content/res/TypedArray;II)Landroid/graphics/drawable/Drawable;
    ...
    .line 36
    .line 37
    sget-object v0, Lcarbon/widget/ImageView;->M:[I
    ...
    .line 41
    .line 42
    sget-object v0, Lcarbon/widget/ImageView;->I:[I
    ...
    .line 46
    .line 47
    sget-object v0, Lcarbon/widget/ImageView;->G:[I
    ...
    .line 51
    .line 52
    sget-object v0, Lcarbon/widget/ImageView;->H:[I
    ...
    .line 56
    .line 57
    sget-object v0, Lcarbon/widget/ImageView;->L:[I
    ...
    .line 61
    .line 62
    sget-object v0, Lcarbon/widget/ImageView;->J:[I
    ...
    .line 66
    .line 67
    sget-object v0, Lcarbon/widget/ImageView;->K:[I
    ...
    .line 78
    invoke-virtual {p0, v0}, Lcarbon/widget/ImageView;->setTooltipText(Ljava/lang/CharSequence;)V
    ...
    .line 86
    invoke-virtual {p0, v1}, Lcarbon/widget/ImageView;->setEnabled(Z)V
    ...
    .line 100
    .line 101
    iput-object v1, p0, Lcarbon/widget/ImageView;->o:Lq3/p;
    ...
    .line 137
    .line 138
    invoke-direct {v7, p0, v1}, La4/x;-><init>(Lcarbon/widget/ImageView;Landroid/graphics/ColorMatrix;)V
    ...
    .line 143
    .line 144
    iget-object v1, p0, Lcarbon/widget/ImageView;->o:Lq3/p;
    ...
    .line 152
    .line 153
    invoke-virtual {v1, v7, v3, v6}, Lq3/p;->a([ILandroid/animation/ValueAnimator;Landroid/animation/AnimatorListenerAdapter;)V
    ...
    .line 187
    .line 188
    invoke-direct {v4, p0, v1}, La4/y;-><init>(Lcarbon/widget/ImageView;Landroid/graphics/ColorMatrix;)V
    ...
    .line 202
    .line 203
    invoke-virtual {v1, p2, v2, v3}, Lq3/p;->a([ILandroid/animation/ValueAnimator;Landroid/animation/AnimatorListenerAdapter;)V
...
.method public onLayout(ZIIII)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcarbon/widget/ImageView;->m()V

    iget-object p1, p0, Lcarbon/widget/ImageView;->f:Lw3/i;
...
.method public final onMeasure(II)V
    ...
    iget v1, p0, Lcarbon/widget/ImageView;->C:I
...
.method public final postInvalidateDelayed(J)V
    ...
    invoke-virtual {p0, p1, p2}, Lcarbon/widget/ImageView;->l(J)V
...
.method public setAnimateColorChangesEnabled(Z)V
    ...
    iget-boolean v0, p0, Lcarbon/widget/ImageView;->w:Z
    ...
    :cond_0
    iput-boolean p1, p0, Lcarbon/widget/ImageView;->w:Z

    iget-object p1, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;

    invoke-virtual {p0, p1}, Lcarbon/widget/ImageView;->setTintList(Landroid/content/res/ColorStateList;)V

    iget-object p1, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lcarbon/widget/ImageView;->setRippleDrawable(Lw3/i;)V
    ...
    iput-object v1, p0, Lcarbon/widget/ImageView;->f:Lw3/i;
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcarbon/widget/ImageView;->u:Landroid/content/res/ColorStateList;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->v:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerCut(F)V
    ...
    .line 20
    .line 21
    invoke-virtual {p0, p1}, Lcarbon/widget/ImageView;->setShapeModel(Loa/i;)V
...
.method public setElevationShadowColor(I)V
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->k:Landroid/content/res/ColorStateList;
...
.method public setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0}, Lcarbon/widget/ImageView;->g()V
...
.method public setImageResource(I)V
    ...
    invoke-direct {v0, p1, v1}, Lv3/l;-><init>(ILandroid/content/res/Resources;)V
...
.method public setRippleDrawable(Lw3/i;)V
    ...
    :cond_2
    iput-object p1, p0, Lcarbon/widget/ImageView;->f:Lw3/i;
...
.method public setStroke(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->z:Landroid/content/res/ColorStateList;
    ...
    :cond_0
    iget-object p1, p0, Lcarbon/widget/ImageView;->B:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->B:Landroid/graphics/Paint;
...
.method public setStrokeWidth(F)V
    ...
    iput p1, p0, Lcarbon/widget/ImageView;->A:F
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lcarbon/widget/ImageView;->x:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcarbon/widget/ImageView;->s:Landroid/content/res/ColorStateList;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lcarbon/widget/ImageView;->t:Landroid/graphics/PorterDuff$Mode;
