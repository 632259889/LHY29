...
.method public static zzA(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/g0;->d(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public static zzB(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v0}, La2/c;->i(Landroid/view/Display;)Landroid/view/Display$Mode;

    move-result-object p0

    invoke-static {p0}, Landroidx/appcompat/widget/r;->e(Landroid/view/Display$Mode;)I

    move-result v0

    iput v0, v4, Landroid/graphics/Point;->x:I

    invoke-static {p0}, Landroidx/appcompat/widget/s;->d(Landroid/view/Display$Mode;)I
