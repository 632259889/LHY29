...
# static fields
.field public static final g:Ldj/v;

.field public static final h:Ldj/v$a;
...
.method public static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Ldj/v$a;

    .line 2
    .line 3
    invoke-direct {v0}, Ldj/v$a;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Ldj/v;->h:Ldj/v$a;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Ldj/v;->e:B

    iput v0, p0, Ldj/v;->f:I

    sget-object v0, Ljj/c;->c:Ljj/o;

    iput-object v0, p0, Ldj/v;->c:Ljj/c;
...
.method public constructor <init>(Ljj/d;Ljj/f;)V
    ...
    iput-object v0, p0, Ldj/v;->d:Ljava/util/List;
    ...
    iput-object v5, p0, Ldj/v;->d:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_2
    iget-object v5, p0, Ldj/v;->d:Ljava/util/List;

    sget-object v6, Ldj/u;->n:Ldj/u$a;
    ...
    iget-object p2, p0, Ldj/v;->d:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Ldj/v;->d:Ljava/util/List;
    ...
    iput-object p2, p0, Ldj/v;->c:Ljj/c;
    ...
    iget-object p1, p0, Ldj/v;->d:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ldj/v;->d:Ljava/util/List;
    ...
    iput-object p1, p0, Ldj/v;->c:Ljj/c;
...
.method public final c()Ljj/p$a;
    ...
    .line 5
    .line 6
    invoke-virtual {v0, p0}, Ldj/v$b;->l(Ldj/v;)V
...
.method public final d()I
    ...
    :goto_0
    iget-object v2, p0, Ldj/v;->d:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Ldj/v;->c:Ljj/c;
...
.method public final e(Ljj/e;)V
    ...
    invoke-virtual {p0}, Ldj/v;->d()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Ldj/v;->d:Ljava/util/List;
