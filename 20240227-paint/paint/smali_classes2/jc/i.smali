...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v0, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
    ...
    iget-object v3, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
    ...
    iget-object v5, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
    ...
    iget-object v4, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
...
.method public final declared-synchronized b()V
    ...
    iget-object v1, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
...
.method public final declared-synchronized c()Ljava/util/ArrayList;
    ...
    .line 59
    .line 60
    invoke-direct {v2, v3, v4}, Ljc/a;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    .line 71
    invoke-virtual {p0, v1, v2}, Ljc/i;->l(J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized d(J)Ljava/lang/String;
    ...
    invoke-static {v0}, La7/c;->k(Ljava/util/Date;)Ljava/time/Instant;

    move-result-object p1

    invoke-static {}, La7/d;->g()Ljava/time/ZoneOffset;

    move-result-object p2

    invoke-static {p1, p2}, La7/e;->i(Ljava/time/Instant;Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;

    move-result-object p1

    invoke-static {p1}, Landroidx/appcompat/widget/g0;->j(Ljava/time/OffsetDateTime;)Ljava/time/LocalDateTime;

    move-result-object p1

    invoke-static {}, Landroidx/appcompat/widget/b0;->m()Ljava/time/format/DateTimeFormatter;

    move-result-object p2

    invoke-static {p1, p2}, La7/b;->i(Ljava/time/LocalDateTime;Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
...
.method public final declared-synchronized f(JJ)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Ljc/i;->d(J)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p3, p4}, Ljc/i;->d(J)Ljava/lang/String;
...
.method public final declared-synchronized g()V
    ...
    invoke-virtual {p0, v0, v1}, Ljc/i;->d(J)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Ljc/i;->h(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized h(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Ljc/i;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
    ...
    iget-object p1, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
...
.method public final declared-synchronized i(J)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Ljc/i;->j(J)Z
...
.method public final declared-synchronized j(J)Z
    ...
    invoke-virtual {p0, v3, v4, p1, p2}, Ljc/i;->f(JJ)Z
...
.method public final declared-synchronized k(Ljava/lang/String;J)V
    ...
    :try_start_0
    invoke-virtual {p0, p2, p3}, Ljc/i;->d(J)Ljava/lang/String;

    move-result-object p2

    iget-object p3, p0, Ljc/i;->a:Landroid/content/SharedPreferences;
