...
.method private initializeAudioTrack()Z
    ...
    invoke-static {v0, v2, v3}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;II)V
...
.method private static isOffloadedPlayback(Landroid/media/AudioTrack;)Z
    ...
    invoke-static {p0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;)Z
...
.method static synthetic lambda$releaseAudioTrackAsync$1(Landroid/media/AudioTrack;Landroidx/media3/exoplayer/audio/AudioSink$Listener;Landroid/os/Handler;Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;Landroidx/media3/common/util/ConditionVariable;)V
    ...
    .line 1820
    new-instance p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda13;

    invoke-direct {p0, p1, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda13;-><init>(Landroidx/media3/exoplayer/audio/AudioSink$Listener;Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;)V
    ...
    .line 1820
    new-instance v1, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda13;

    invoke-direct {v1, p1, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda13;-><init>(Landroidx/media3/exoplayer/audio/AudioSink$Listener;Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;)V
...
.method private static releaseAudioTrackAsync(Landroid/media/AudioTrack;Landroidx/media3/common/util/ConditionVariable;Landroidx/media3/exoplayer/audio/AudioSink$Listener;Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;)V
    ...
    new-instance v8, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda14;
...
.method private setAudioTrackPlaybackParametersV23()V
    ...
    .line 1512
    invoke-static {}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m()Landroid/media/PlaybackParams;

    move-result-object v0

    .line 1514
    invoke-static {v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/PlaybackParams;)Landroid/media/PlaybackParams;
    ...
    .line 1515
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/PlaybackParams;F)Landroid/media/PlaybackParams;
    ...
    .line 1516
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m$1(Landroid/media/PlaybackParams;F)Landroid/media/PlaybackParams;
    ...
    .line 1517
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/PlaybackParams;I)Landroid/media/PlaybackParams;
    ...
    invoke-static {v1, v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;Landroid/media/PlaybackParams;)V
    :try_end_0
    ...
    .line 1526
    invoke-static {v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;)Landroid/media/PlaybackParams;

    move-result-object v1

    invoke-static {v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/PlaybackParams;)F

    move-result v1

    iget-object v2, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->audioTrack:Landroid/media/AudioTrack;

    invoke-static {v2}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;)Landroid/media/PlaybackParams;

    move-result-object v2

    invoke-static {v2}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m$1(Landroid/media/PlaybackParams;)F
...
.method private writeNonBlockingWithAvSyncV21(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IJ)I
    ...
    .line 1745
    invoke-static/range {v4 .. v9}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IIJ)I
...
.method public handleBuffer(Ljava/nio/ByteBuffer;JI)Z
    ...
    invoke-static {v5}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;)V
    ...
    invoke-static {v5, v9, v10}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;II)V
...
.method public setOffloadDelayPadding(II)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;II)V
