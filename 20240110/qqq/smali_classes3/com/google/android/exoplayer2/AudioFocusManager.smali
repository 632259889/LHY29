...
.method private abandonAudioFocusV26()V
    ...
    invoke-static {v1, v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m$1(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)I
...
.method private requestAudioFocusV26()I
    ...
    .line 261
    invoke-static {}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m()V

    iget v0, p0, Lcom/google/android/exoplayer2/AudioFocusManager;->focusGainToRequest:I

    invoke-static {v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(I)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioFocusRequest;)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0, v2}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    .line 268
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioFocusRequest$Builder;Z)Landroid/media/AudioFocusRequest$Builder;
    ...
    .line 269
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioManager$OnAudioFocusChangeListener;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    .line 270
    invoke-static {v0}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioFocusRequest$Builder;)Landroid/media/AudioFocusRequest;
    ...
    invoke-static {v0, v1}, Landroidx/media3/common/util/Util$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)I
