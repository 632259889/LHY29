...
.method public constructor <init>(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/n;)V
    ...
    iput-boolean v9, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->j:Z
    ...
    invoke-direct {v1, v9, v3}, Lcom/applovin/impl/mediation/debugger/b/b/b;->a(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/n;)Ljava/util/List;

    move-result-object v10

    iput-object v10, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->u:Ljava/util/List;

    new-instance v10, Lcom/applovin/impl/mediation/debugger/b/b/c;

    invoke-direct {v10, v9, v3}, Lcom/applovin/impl/mediation/debugger/b/b/c;-><init>(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/n;)V

    iput-object v10, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->x:Lcom/applovin/impl/mediation/debugger/b/b/c;
    ...
    invoke-static {v10, v13, v12}, Lcom/applovin/impl/sdk/utils/JsonUtils;->getBoolean(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    invoke-static {v2, v12, v8}, Lcom/applovin/impl/sdk/utils/JsonUtils;->getBoolean(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    invoke-static {v10, v8, v12}, Lcom/applovin/impl/sdk/utils/JsonUtils;->getString(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->r:Ljava/lang/String;

    const-string v8, "existence_classes"

    invoke-static {v2, v8, v12}, Lcom/applovin/impl/sdk/utils/JsonUtils;->getList(Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    if-eqz v8, :cond_0

    invoke-static {v8}, Lcom/applovin/impl/sdk/utils/Utils;->checkClassesExistence(Ljava/util/List;)Z
    ...
    :cond_0
    const-string v8, "existence_class"

    invoke-static {v2, v8, v5}, Lcom/applovin/impl/sdk/utils/JsonUtils;->getString(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    invoke-static {v8}, Lcom/applovin/impl/sdk/utils/Utils;->checkClassExistence(Ljava/lang/String;)Z

    move-result v8

    :goto_0
    iput-boolean v8, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->d:Z
    ...
    iput-object v8, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->t:Ljava/util/List;

    iput-boolean v0, v1, Lcom/applovin/impl/mediation/debugger/b/b/b;->k:Z

    invoke-direct {v1, v9, v13, v3}, Lcom/applovin/impl/mediation/debugger/b/b/b;->a(Lorg/json/JSONObject;Ljava/lang/String;Lcom/applovin/impl/sdk/n;)Ljava/util/List;
