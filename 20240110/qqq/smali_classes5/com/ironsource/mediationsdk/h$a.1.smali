...
.method private a()Z
    ...
    sget-object v12, Lcom/ironsource/mediationsdk/logger/IronLog;->INTERNAL:Lcom/ironsource/mediationsdk/logger/IronLog;

    const-string v6, "compressing and encrypting auction request"

    invoke-virtual {v12, v6}, Lcom/ironsource/mediationsdk/logger/IronLog;->verbose(Ljava/lang/String;)V

    invoke-static {v8, v0}, Lcom/ironsource/mediationsdk/utils/IronSourceAES;->compressAndEncrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {v8, v0}, Lcom/ironsource/mediationsdk/utils/IronSourceAES;->encode(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v8, v1, Lcom/ironsource/mediationsdk/h$a;->u:Z
    ...
    const-string v8, "decrypting and decompressing auction response"

    invoke-virtual {v6, v8}, Lcom/ironsource/mediationsdk/logger/IronLog;->verbose(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/ironsource/mediationsdk/f;->a(Lorg/json/JSONObject;)Lcom/ironsource/mediationsdk/f$a;
