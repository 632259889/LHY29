...
# instance fields
.field private final boundaryByteString:Li/i;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(Lf/c0/d/g;)V
...
.method public constructor <init>(Li/i;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:Li/i;
...
.method private final writeOrCountBytes(Li/g;Z)J
    ...
    invoke-interface {p1, v8}, Li/g;->X([B)Li/g;

    .line 7
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Li/i;

    invoke-interface {p1, v8}, Li/g;->Y(Li/i;)Li/g;
    ...
    invoke-interface {p1, v10}, Li/g;->J(Ljava/lang/String;)Li/g;
    ...
    invoke-interface {v10, v11}, Li/g;->X([B)Li/g;
    ...
    invoke-interface {v10, v11}, Li/g;->J(Ljava/lang/String;)Li/g;
    ...
    .line 15
    invoke-interface {p1, v8}, Li/g;->J(Ljava/lang/String;)Li/g;
    ...
    invoke-interface {v8, v7}, Li/g;->J(Ljava/lang/String;)Li/g;
    ...
    invoke-interface {v7, v8}, Li/g;->X([B)Li/g;
    ...
    .line 19
    invoke-interface {p1, v9}, Li/g;->J(Ljava/lang/String;)Li/g;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Li/g;->g0(J)Li/g;
    ...
    invoke-interface {v9, v10}, Li/g;->X([B)Li/g;
    ...
    invoke-interface {p1, v9}, Li/g;->X([B)Li/g;
    ...
    .line 24
    :cond_7
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Li/g;)V
    ...
    invoke-interface {p1, v1}, Li/g;->X([B)Li/g;

    .line 27
    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Li/i;

    invoke-interface {p1, v2}, Li/g;->Y(Li/i;)Li/g;
...
.method public final boundary()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:Li/i;

    invoke-virtual {v0}, Li/i;->utf8()Ljava/lang/String;
...
.method public contentLength()J
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Li/g;Z)J
...
.method public writeTo(Li/g;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Li/g;Z)J
