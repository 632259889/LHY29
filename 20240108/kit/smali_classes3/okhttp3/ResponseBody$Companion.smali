...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Li/h;Lokhttp3/MediaType;JILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion;->create(Li/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;Li/i;Lokhttp3/MediaType;ILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2}, Lokhttp3/ResponseBody$Companion;->create(Li/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
# virtual methods
.method public final create(Li/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion$asResponseBody$1;-><init>(Li/h;Lokhttp3/MediaType;J)V

    return-object v0
.end method

.method public final create(Li/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    .locals 3
    ...
    invoke-virtual {p0, v0, p2, v1, v2}, Lokhttp3/ResponseBody$Companion;->create(Li/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Ljava/lang/String;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v1, p1, v0}, Li/f;->J0(Ljava/lang/String;Ljava/nio/charset/Charset;)Li/f;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lokhttp3/ResponseBody$Companion;->create(Li/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;JLi/h;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 16
    invoke-virtual {p0, p4, p1, p2, p3}, Lokhttp3/ResponseBody$Companion;->create(Li/h;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;Li/i;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 15
    invoke-virtual {p0, p2, p1}, Lokhttp3/ResponseBody$Companion;->create(Li/i;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
