...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(Lf/c0/d/g;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILf/c0/d/g;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Li/i;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Li/i;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Li/i;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Li/i;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lf/c0/c/a;)V
...
.method public final varargs check(Ljava/lang/String;[Ljava/security/cert/Certificate;)V
    ...
    .line 2
    invoke-static {p2}, Lf/x/f;->v([Ljava/lang/Object;)Ljava/util/List;
...
.method public final check$okhttp(Ljava/lang/String;Lf/c0/c/a;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    :cond_0
    invoke-interface {p2}, Lf/c0/c/a;->invoke()Ljava/lang/Object;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Li/i;

    move-result-object v5

    .line 9
    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Li/i;
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Li/i;
    ...
    invoke-static {v6, v4}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 7
    :cond_1
    invoke-static {v1}, Lf/c0/d/z;->a(Ljava/lang/Object;)Ljava/util/List;
