...
# direct methods
.method public constructor <init>(ILi/f;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLi/f;ILf/c0/d/g;)V
...
.method public constructor <init>(IZLi/f;)V
    ...
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Li/f;
...
.method public synthetic constructor <init>(IZLi/f;ILf/c0/d/g;)V
    .locals 0
    ...
    .line 6
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLi/f;)V
...
.method private final clearDynamicTable()V
    ...
    invoke-static/range {v0 .. v5}, Lf/x/f;->m([Ljava/lang/Object;Ljava/lang/Object;IIILjava/lang/Object;)V
...
.method public final writeByteString(Li/i;)V
    .locals 4
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Li/i;)I
    ...
    .line 3
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Li/i;Li/g;)V

    .line 4
    invoke-virtual {v2}, Li/f;->R()Li/i;
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Li/f;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Li/i;

    invoke-virtual {v4}, Li/i;->toAsciiLowercase()Li/i;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Li/i;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Li/i;

    invoke-static {v9, v5}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Li/i;

    invoke-static {v6, v5}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_6
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Li/i;

    invoke-static {v11, v4}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_7
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Li/i;

    invoke-static {v11, v5}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 21
    iget-object v6, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Li/f;

    invoke-virtual {v6, v7}, Li/f;->C0(I)Li/f;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Li/i;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Li/i;)V
    ...
    .line 25
    :cond_c
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Li/i;

    invoke-virtual {v4, v8}, Li/i;->startsWith(Li/i;)Z

    move-result v8

    if-eqz v8, :cond_d

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Li/i;

    invoke-static {v8, v4}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Li/f;
    ...
    invoke-virtual {v0, p3}, Li/f;->C0(I)Li/f;
    ...
    invoke-virtual {v0, p2}, Li/f;->C0(I)Li/f;
