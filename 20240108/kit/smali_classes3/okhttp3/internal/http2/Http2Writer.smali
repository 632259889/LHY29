...
.field private final hpackBuffer:Li/f;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lf/c0/d/g;)V
...
.method public constructor <init>(Li/g;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li/f;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLi/f;ILf/c0/d/g;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li/f;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Li/i;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Li/i;

    invoke-interface {v0, v1}, Li/g;->Y(Li/i;)Li/g;
...
.method public final declared-synchronized data(ZILi/f;I)V
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILi/f;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILi/f;I)V
    .locals 2
    ...
    invoke-interface {p1, p3, v0, v1}, Li/b0;->write(Li/f;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Li/g;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Li/g;->w(I)Li/g;
    ...
    invoke-interface {p2, p1}, Li/g;->p(I)Li/g;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Li/g;->p(I)Li/g;
    ...
    invoke-interface {p1, p2}, Li/g;->p(I)Li/g;
    ...
    invoke-interface {p1, p3}, Li/g;->X([B)Li/g;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li/f;

    invoke-virtual {p3}, Li/f;->u0()J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li/f;

    invoke-interface {p1, v4, v2, v3}, Li/b0;->write(Li/f;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Li/g;->p(I)Li/g;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Li/g;->p(I)Li/g;

    .line 7
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Li/f;

    invoke-interface {p2, v2, v4, v5}, Li/b0;->write(Li/f;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    invoke-interface {v4, v3}, Li/g;->n(I)Li/g;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Li/g;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Li/g;->p(I)Li/g;
