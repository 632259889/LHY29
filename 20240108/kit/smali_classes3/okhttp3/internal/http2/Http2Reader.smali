...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lf/c0/d/g;)V
...
.method public constructor <init>(Li/h;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Li/h;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Li/d0;IIILf/c0/d/g;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILi/h;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
    ...
    invoke-interface {v0, v1, v2}, Li/h;->l(J)Li/i;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Li/i;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lf/e0/n;->i(II)Lf/e0/j;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lf/e0/n;->h(Lf/e0/h;I)Lf/e0/h;

    move-result-object p2

    invoke-virtual {p2}, Lf/e0/h;->d()I

    move-result v1

    invoke-virtual {p2}, Lf/e0/h;->e()I

    move-result v2

    invoke-virtual {p2}, Lf/e0/h;->g()I
    ...
    .line 7
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Li/h;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Li/h;)I
    ...
    invoke-interface {p1, v0, v1}, Li/h;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Li/i;
    ...
    invoke-interface {p1, v2, v3}, Li/h;->l(J)Li/i;
    ...
    invoke-virtual {p1}, Li/i;->utf8()Ljava/lang/String;
