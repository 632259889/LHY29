...
.method private final newSource(I)Li/d0;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Li/d0;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Li/d0;Li/d0;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Li/d0;
...
.method public final writeLengths$okhttp(Li/g;)V
    .locals 6
    ...
    .line 2
    invoke-interface {p1, v5}, Li/g;->w(I)Li/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Li/g;->g0(J)Li/g;
