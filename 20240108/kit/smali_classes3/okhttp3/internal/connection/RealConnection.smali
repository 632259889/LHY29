...
.field private sink:Li/g;

.field private socket:Ljava/net/Socket;

.field private source:Li/h;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Lf/c0/d/g;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 10
    :try_start_1
    invoke-static {v1}, Li/q;->l(Ljava/net/Socket;)Li/d0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;

    .line 11
    invoke-static {v1}, Li/q;->h(Ljava/net/Socket;)Li/b0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Li/g;
    :try_end_1
    ...
    invoke-static {p2, p3}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {v3, v5}, Lf/c0/d/l;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v0, v5}, Lf/c0/d/l;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 21
    invoke-static {p1, v2, v6, v2}, Lf/h0/n;->e(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .line 29
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lf/c0/c/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lf/c0/c/a;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Li/g;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 2
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Li/g;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Li/h;Li/g;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Li/e0;->timeout(JLjava/util/concurrent/TimeUnit;)Li/e0;

    .line 6
    invoke-interface {v2}, Li/b0;->timeout()Li/e0;
    ...
    invoke-static {v2, p3, v1}, Lf/h0/n;->l(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Li/f;->v()Z

    move-result p1

    if-eqz p1, :cond_7

    invoke-interface {v2}, Li/g;->d()Li/f;
...
.method private final routeMatchesAny(Ljava/util/List;)Z
    ...
    invoke-static {v3, v0}, Lf/c0/d/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private final startHttp2(I)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Li/h;Li/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v8, v0}, Lf/c0/d/l;->g(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v0, "eventListener"

    invoke-static {v9, v0}, Lf/c0/d/l;->g(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 26
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Li/h;

    .line 27
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Li/g;
...
.method public final isHealthy(Z)Z
    ...
    .line 4
    :cond_1
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;
    ...
    .line 9
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Li/h;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 7
    invoke-interface {v1}, Li/d0;->timeout()Li/e0;
    ...
    invoke-virtual {v0, v3, v4, v5}, Li/e0;->timeout(JLjava/util/concurrent/TimeUnit;)Li/e0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Li/h;Li/g;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .line 2
    :cond_0
    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->source:Li/h;
    ...
    .line 3
    :cond_1
    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->sink:Li/g;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokhttp3/internal/connection/Exchange;Li/h;Li/g;ZLi/h;Li/g;)V
...
.method public onSettings(Lokhttp3/internal/http2/Http2Connection;Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-static {p2, p1}, Lf/c0/d/l;->g(Ljava/lang/Object;Ljava/lang/String;)V
