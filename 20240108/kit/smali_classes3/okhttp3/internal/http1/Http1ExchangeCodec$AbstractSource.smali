...
.field private final timeout:Li/m;
...
.method public constructor <init>(Lokhttp3/internal/http1/Http1ExchangeCodec;)V
    ...
    invoke-static {p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Li/h;

    move-result-object p1

    invoke-interface {p1}, Li/d0;->timeout()Li/e0;

    move-result-object p1

    invoke-direct {v0, p1}, Li/m;-><init>(Li/e0;)V

    iput-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;->timeout:Li/m;
...
.method protected final getTimeout()Li/m;
    .locals 1

    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;->timeout:Li/m;
...
.method public read(Li/f;J)J
    ...
    invoke-static {v0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Li/h;

    move-result-object v0

    invoke-interface {v0, p1, p2, p3}, Li/d0;->read(Li/f;J)J
...
.method public final responseBodyComplete$okhttp()V
    ...
    iget-object v2, p0, Lokhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;->timeout:Li/m;

    invoke-static {v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;->access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Li/m;)V
