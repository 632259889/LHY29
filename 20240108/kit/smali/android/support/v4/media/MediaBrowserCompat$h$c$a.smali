...
.field final synthetic p:Landroid/support/v4/media/MediaBrowserCompat$h$c;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$h$c;Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->p:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->n:Landroid/content/ComponentName;

    iput-object p3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->o:Landroid/os/IBinder;
...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->n:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->o:Landroid/os/IBinder;
    ...
    .line 3
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->p:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$h$c;->n:Landroid/support/v4/media/MediaBrowserCompat$h;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->o:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->p:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$h$c;->n:Landroid/support/v4/media/MediaBrowserCompat$h;
    ...
    .line 10
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->p:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$h$c;->n:Landroid/support/v4/media/MediaBrowserCompat$h;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$h$c$a;->p:Landroid/support/v4/media/MediaBrowserCompat$h$c;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$h$c;->n:Landroid/support/v4/media/MediaBrowserCompat$h;
