...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    const-string p0, "getFileUri current activity is null."
    ...
    .line 7
    :pswitch_0
    invoke-static {p0, p2}, Ld/a/a/a;->e(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 8
    :pswitch_1
    invoke-static {p0, p2}, Ld/a/a/a;->f(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 9
    :pswitch_2
    invoke-static {p0, p2}, Ld/a/a/a;->c(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 10
    :pswitch_3
    invoke-static {p0, p2}, Ld/a/a/a;->b(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 11
    invoke-static {p2}, Ld/a/a/a;->a(Ljava/io/File;)Landroid/net/Uri;
    ...
    :cond_9
    :goto_2
    const-string p0, "getFileUri file is null or not exists."
...
.method private static e(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    .locals 7
...
.method private static f(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    .locals 7
