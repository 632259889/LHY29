...
.method public static synthetic a(Lorg/json/JSONArray;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p0}, Lbolts/p;->g(Lorg/json/JSONArray;)Ljava/util/Map;
...
.method public static synthetic b(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lbolts/p;->f(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
...
.method public static synthetic c(Lbolts/p;)Landroid/content/Context;
    .locals 0

    .line 1
    iget-object p0, p0, Lbolts/p;->a:Landroid/content/Context;
...
.method public static synthetic d(Ljava/net/URLConnection;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lbolts/p;->h(Ljava/net/URLConnection;)Ljava/lang/String;
...
.method private static f(Ljava/util/Map;Landroid/net/Uri;)Lbolts/b;
    ...
    .line 5
    invoke-static {v3, v4}, Lbolts/p;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 6
    invoke-static {v3, v8}, Lbolts/p;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 7
    invoke-static {v3, v9}, Lbolts/p;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 8
    invoke-static {v3, v10}, Lbolts/p;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 11
    invoke-static {v11}, Lbolts/p;->i(Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 27
    invoke-static {v0}, Lbolts/p;->i(Ljava/lang/String;)Landroid/net/Uri;
...
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Lbolts/m;
    ...
    .line 3
    new-instance v2, Lbolts/p$c;

    invoke-direct {v2, p0, p1, v0, v1}, Lbolts/p$c;-><init>(Lbolts/p;Landroid/net/Uri;Lbolts/j;Lbolts/j;)V

    invoke-static {v2}, Lbolts/m;->g(Ljava/util/concurrent/Callable;)Lbolts/m;

    move-result-object v2

    new-instance v3, Lbolts/p$b;

    invoke-direct {v3, p0, v1, p1, v0}, Lbolts/p$b;-><init>(Lbolts/p;Lbolts/j;Landroid/net/Uri;Lbolts/j;)V

    sget-object v0, Lbolts/m;->k:Ljava/util/concurrent/Executor;

    invoke-virtual {v2, v3, v0}, Lbolts/m;->R(Lbolts/k;Ljava/util/concurrent/Executor;)Lbolts/m;

    move-result-object v0

    new-instance v1, Lbolts/p$a;

    invoke-direct {v1, p0, p1}, Lbolts/p$a;-><init>(Lbolts/p;Landroid/net/Uri;)V
