...
.field public static final B:I = 0x2c
...
.field private static final b:Ljava/lang/String; = "android.support.v4.media.session.IMediaSession"
...
.field public static final e1:I = 0x1a
...
.field public static final v:I = 0x25

.field public static final w:I = 0x26

.field public static final x:I = 0x2f

.field public static final y:I = 0x29

.field public static final z:I = 0x2a
...
.method public static i()Landroid/support/v4/media/session/b;
    ...
    .line 1
    sget-object v0, Landroid/support/v4/media/session/b$b$a;->c:Landroid/support/v4/media/session/b;

    return-object v0
.end method

.method public static j(Landroid/support/v4/media/session/b;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 2
    sput-object p0, Landroid/support/v4/media/session/b$b$a;->c:Landroid/support/v4/media/session/b;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 7
    :cond_1
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->I1(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    .line 29
    :cond_3
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->k0(Z)V
    ...
    .line 37
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->a2(I)V
    ...
    .line 42
    :cond_4
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->a0(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 48
    invoke-interface {p0, v3, p1}, Landroid/support/v4/media/session/b;->N1(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    .line 53
    :cond_6
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->b0(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 57
    :cond_7
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->y2(Z)V
    ...
    .line 76
    :cond_9
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->E0(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    .line 82
    :cond_a
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->p3(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 104
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->e0()Ljava/lang/CharSequence;
    ...
    .line 110
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->p0()Ljava/util/List;
    ...
    .line 129
    :cond_10
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->x0(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 134
    :cond_11
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->c3(Landroid/support/v4/media/RatingCompat;)V
    ...
    .line 160
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->x2(J)V
    ...
    .line 167
    :cond_13
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->l1(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    .line 173
    :cond_14
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->g1(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 188
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->f3(IILjava/lang/String;)V
    ...
    .line 194
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->o4(IILjava/lang/String;)V
    ...
    .line 197
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->d5()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    .line 203
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->D()J
    ...
    .line 221
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->k3()Z
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/a$b;->h(Landroid/os/IBinder;)Landroid/support/v4/media/session/a;

    move-result-object p1

    .line 226
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->G3(Landroid/support/v4/media/session/a;)V
    ...
    .line 235
    :cond_18
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->z1(Landroid/view/KeyEvent;)Z
    ...
    .line 244
    :cond_1a
    invoke-interface {p0, p1, p4, v3}, Landroid/support/v4/media/session/b;->k2(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
