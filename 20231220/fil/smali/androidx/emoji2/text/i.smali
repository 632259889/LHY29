...
# instance fields
.field private final a:Landroidx/emoji2/text/e$l;
...
# direct methods
.method public constructor <init>(Landroidx/emoji2/text/o;Landroidx/emoji2/text/e$l;Landroidx/emoji2/text/e$e;Z[I)V
    .locals 0
    ...
    .line 2
    iput-object p2, p0, Landroidx/emoji2/text/i;->a:Landroidx/emoji2/text/e$l;

    .line 3
    iput-object p1, p0, Landroidx/emoji2/text/i;->b:Landroidx/emoji2/text/o;

    .line 4
    iput-object p3, p0, Landroidx/emoji2/text/i;->c:Landroidx/emoji2/text/e$e;
...
.method private a(Landroid/text/Spannable;Landroidx/emoji2/text/h;II)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/emoji2/text/i;->a:Landroidx/emoji2/text/e$l;

    invoke-virtual {v0, p2}, Landroidx/emoji2/text/e$l;->a(Landroidx/emoji2/text/h;)Landroidx/emoji2/text/j;
...
.method private static b(Landroid/text/Editable;Landroid/view/KeyEvent;Z)Z
    ...
    .line 1
    invoke-static {p1}, Landroidx/emoji2/text/i;->i(Landroid/view/KeyEvent;)Z
    ...
    .line 4
    invoke-static {p1, v1}, Landroidx/emoji2/text/i;->h(II)Z
...
.method public static e(Landroid/view/inputmethod/InputConnection;Landroid/text/Editable;IIZ)Z
    ...
    .line 3
    invoke-static {v1, v2}, Landroidx/emoji2/text/i;->h(II)Z
...
.method private g(Ljava/lang/CharSequence;IILandroidx/emoji2/text/h;)Z
    .locals 2

    .line 1
    invoke-virtual {p4}, Landroidx/emoji2/text/h;->e()I
    ...
    .line 2
    iget-object v0, p0, Landroidx/emoji2/text/i;->c:Landroidx/emoji2/text/e$e;

    .line 3
    invoke-virtual {p4}, Landroidx/emoji2/text/h;->i()S
    ...
    .line 5
    invoke-virtual {p4, p1}, Landroidx/emoji2/text/h;->n(Z)V
...
.method public d(Ljava/lang/CharSequence;I)I
    ...
    .line 1
    new-instance v0, Landroidx/emoji2/text/i$c;
    ...
    invoke-direct {v0, v1, v2, v3}, Landroidx/emoji2/text/i$c;-><init>(Landroidx/emoji2/text/o$a;Z[I)V
    ...
    .line 4
    invoke-virtual {v0, v8}, Landroidx/emoji2/text/i$c;->a(I)I

    move-result v9

    .line 5
    invoke-virtual {v0}, Landroidx/emoji2/text/i$c;->b()Landroidx/emoji2/text/h;
    ...
    .line 6
    :cond_1
    invoke-virtual {v0}, Landroidx/emoji2/text/i$c;->c()Landroidx/emoji2/text/h;

    move-result-object v10

    .line 7
    invoke-virtual {v10}, Landroidx/emoji2/text/h;->d()S
    ...
    .line 11
    :cond_6
    invoke-virtual {v0}, Landroidx/emoji2/text/i$c;->e()Z
    ...
    .line 13
    invoke-virtual {p1}, Landroidx/emoji2/text/h;->d()S
...
.method public j(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
    ...
    const-class v4, Landroidx/emoji2/text/j;
    ...
    .line 19
    :cond_7
    new-instance v3, Landroidx/emoji2/text/i$c;

    iget-object v4, p0, Landroidx/emoji2/text/i;->b:Landroidx/emoji2/text/o;

    invoke-virtual {v4}, Landroidx/emoji2/text/o;->i()Landroidx/emoji2/text/o$a;
    ...
    invoke-direct {v3, v4, v5, v6}, Landroidx/emoji2/text/i$c;-><init>(Landroidx/emoji2/text/o$a;Z[I)V
    ...
    .line 21
    invoke-virtual {v3, v5}, Landroidx/emoji2/text/i$c;->a(I)I
    ...
    .line 22
    invoke-virtual {v3}, Landroidx/emoji2/text/i$c;->c()Landroidx/emoji2/text/h;

    move-result-object v6

    .line 23
    invoke-direct {p0, p1, v1, p2, v6}, Landroidx/emoji2/text/i;->g(Ljava/lang/CharSequence;IILandroidx/emoji2/text/h;)Z
    ...
    invoke-direct {p0, v2, v6, v1, p2}, Landroidx/emoji2/text/i;->a(Landroid/text/Spannable;Landroidx/emoji2/text/h;II)V
    ...
    .line 30
    :cond_10
    invoke-virtual {v3}, Landroidx/emoji2/text/i$c;->e()Z
    ...
    .line 31
    invoke-virtual {v3}, Landroidx/emoji2/text/i$c;->b()Landroidx/emoji2/text/h;

    move-result-object p3

    .line 32
    invoke-direct {p0, p1, v1, p2, p3}, Landroidx/emoji2/text/i;->g(Ljava/lang/CharSequence;IILandroidx/emoji2/text/h;)Z
    ...
    invoke-direct {p0, v2, p3, v1, p2}, Landroidx/emoji2/text/i;->a(Landroid/text/Spannable;Landroidx/emoji2/text/h;II)V
    :try_end_0
