...
# static fields
.field private static final b:Ljava/lang/String; = "android:changeImageTransform:matrix"

.field private static final c:Ljava/lang/String; = "android:changeImageTransform:bounds"
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/g;->e:Landroid/animation/TypeEvaluator;
...
.method private static b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 4
    :cond_0
    invoke-static {p0}, Landroidx/transition/g;->a(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 5
    :cond_1
    invoke-static {p0}, Landroidx/transition/g;->e(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private c(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    .line 1
    sget-object v0, Landroidx/transition/g;->f:Landroid/util/Property;

    new-instance v1, Landroidx/transition/m0$a;

    invoke-direct {v1}, Landroidx/transition/m0$a;-><init>()V
...
.method private captureValues(Landroidx/transition/n0;)V
    ...
    .line 12
    invoke-static {v1}, Landroidx/transition/g;->b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private d(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v1, Landroidx/transition/g;->e:Landroid/animation/TypeEvaluator;

    const/4 v2, 0x2

    new-array v2, v2, [Landroid/graphics/Matrix;

    sget-object v3, Landroidx/transition/v;->a:Landroid/graphics/Matrix;
...
.method public captureEndValues(Landroidx/transition/n0;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/g;->captureValues(Landroidx/transition/n0;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/n0;Landroidx/transition/n0;)Landroid/animation/Animator;
    ...
    .line 3
    :cond_1
    iget-object p2, p2, Landroidx/transition/n0;->a:Ljava/util/Map;
    ...
    .line 4
    iget-object v3, p3, Landroidx/transition/n0;->a:Ljava/util/Map;
    ...
    .line 7
    :cond_5
    iget-object p1, p3, Landroidx/transition/n0;->b:Landroid/view/View;
    ...
    .line 11
    sget-object p2, Landroidx/transition/v;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    .line 12
    sget-object v2, Landroidx/transition/v;->a:Landroid/graphics/Matrix;

    .line 13
    :cond_8
    sget-object p3, Landroidx/transition/g;->f:Landroid/util/Property;

    invoke-virtual {p3, p1, p2}, Landroid/util/Property;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    .line 14
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/g;->c(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/g;->d(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
