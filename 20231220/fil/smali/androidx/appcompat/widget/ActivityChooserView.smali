...
.field public k:Landroidx/core/view/b;
...
.method public a()Z
    ...
    .line 2
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActivityChooserView;->getListPopupWindow()Landroidx/appcompat/widget/u0;
...
.method public d(I)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/ActivityChooserView$f;->b()I
    ...
    invoke-virtual {v3, v1}, Landroidx/appcompat/widget/ActivityChooserView$f;->m(Z)V
    ...
    invoke-virtual {v3, p1}, Landroidx/appcompat/widget/ActivityChooserView$f;->k(I)V
    ...
    invoke-virtual {v3, v2}, Landroidx/appcompat/widget/ActivityChooserView$f;->m(Z)V
    ...
    .line 11
    invoke-virtual {p1}, Landroidx/appcompat/widget/u0;->a()Z
    ...
    invoke-virtual {v0, v2, v2}, Landroidx/appcompat/widget/ActivityChooserView$f;->l(ZZ)V
    ...
    invoke-virtual {v3, v1, v0}, Landroidx/appcompat/widget/ActivityChooserView$f;->l(ZZ)V

    .line 15
    :goto_3
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->b:Landroidx/appcompat/widget/ActivityChooserView$f;

    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$f;->i()I
    ...
    .line 16
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/u0;->S(I)V

    .line 17
    invoke-virtual {p1}, Landroidx/appcompat/widget/u0;->show()V

    .line 18
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->k:Landroidx/core/view/b;
    ...
    .line 20
    :cond_4
    invoke-virtual {p1}, Landroidx/appcompat/widget/u0;->o()Landroid/widget/ListView;
...
.method public e()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$f;->b()I
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/ActivityChooserView$f;->e()I
...
.method public getListPopupWindow()Landroidx/appcompat/widget/u0;
    .locals 2

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/u0;
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/widget/u0;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/u0;

    .line 3
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->b:Landroidx/appcompat/widget/ActivityChooserView$f;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/u0;->m(Landroid/widget/ListAdapter;)V

    .line 4
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->n:Landroidx/appcompat/widget/u0;

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/u0;->Q(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/u0;->d0(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/u0;->c0(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public setActivityChooserModel(Landroidx/appcompat/widget/c;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/ActivityChooserView$f;->j(Landroidx/appcompat/widget/c;)V
...
.method public setProvider(Landroidx/core/view/b;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->k:Landroidx/core/view/b;
