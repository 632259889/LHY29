...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/core/app/c0$d;,
        Landroidx/core/app/c0$e;,
        Landroidx/core/app/c0$a;,
        Landroidx/core/app/c0$b;,
        Landroidx/core/app/c0$c;,
        Landroidx/core/app/c0$f;,
        Landroidx/core/app/c0$g;,
        Landroidx/core/app/c0$h;
    }
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/Set;)V
    ...
    .line 9
    invoke-virtual {p0}, Landroidx/core/app/c0;->k()I
...
.method public static a(Landroidx/core/app/c0;Landroid/content/Intent;Ljava/util/Map;)V
    .locals 5
    .param p0    # Landroidx/core/app/c0;
    ...
    .line 2
    invoke-static {p0, p1, p2}, Landroidx/core/app/c0$c;->a(Landroidx/core/app/c0;Landroid/content/Intent;Ljava/util/Map;)V
    ...
    .line 3
    invoke-static {p1}, Landroidx/core/app/c0;->i(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 8
    :cond_2
    invoke-static {v2}, Landroidx/core/app/c0;->l(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 13
    invoke-static {p1, p0}, Landroidx/core/app/c0$a;->b(Landroid/content/Intent;Landroid/content/ClipData;)V
...
.method public static b([Landroidx/core/app/c0;Landroid/content/Intent;Landroid/os/Bundle;)V
    .locals 8
    .param p0    # [Landroidx/core/app/c0;
        .annotation build Lk/f0;
        .end annotation
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/app/c0$b;->a(Ljava/lang/Object;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 3
    invoke-static {p1}, Landroidx/core/app/c0;->p(Landroid/content/Intent;)Landroid/os/Bundle;

    move-result-object v0

    .line 4
    invoke-static {p1}, Landroidx/core/app/c0;->q(Landroid/content/Intent;)I
    ...
    .line 7
    invoke-virtual {v4}, Landroidx/core/app/c0;->o()Ljava/lang/String;

    move-result-object v5

    .line 8
    invoke-static {p1, v5}, Landroidx/core/app/c0;->j(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/Map;

    move-result-object v5

    const/4 v6, 0x1

    new-array v6, v6, [Landroidx/core/app/c0;

    aput-object v4, v6, v2

    .line 9
    invoke-static {v6}, Landroidx/core/app/c0;->d([Landroidx/core/app/c0;)[Landroid/app/RemoteInput;

    move-result-object v6

    invoke-static {v6, p1, p2}, Landroidx/core/app/c0$b;->a(Ljava/lang/Object;Landroid/content/Intent;Landroid/os/Bundle;)V

    if-eqz v5, :cond_2

    .line 10
    invoke-static {v4, p1, v5}, Landroidx/core/app/c0;->a(Landroidx/core/app/c0;Landroid/content/Intent;Ljava/util/Map;)V
    ...
    .line 11
    :cond_3
    invoke-static {p1, v1}, Landroidx/core/app/c0;->s(Landroid/content/Intent;I)V
    ...
    .line 17
    invoke-virtual {v5}, Landroidx/core/app/c0;->o()Ljava/lang/String;
...
.method public static c(Landroidx/core/app/c0;)Landroid/app/RemoteInput;
    .locals 0
    ...
    .line 1
    invoke-static {p0}, Landroidx/core/app/c0$b;->b(Landroidx/core/app/c0;)Landroid/app/RemoteInput;
...
.method public static d([Landroidx/core/app/c0;)[Landroid/app/RemoteInput;
    .locals 3
    .annotation build Landroidx/annotation/i;
        value = 0x14
    .end annotation
    ...
    invoke-static {v2}, Landroidx/core/app/c0;->c(Landroidx/core/app/c0;)Landroid/app/RemoteInput;
...
.method public static e(Landroid/app/RemoteInput;)Landroidx/core/app/c0;
    .locals 0
    .annotation build Landroidx/annotation/i;
        value = 0x14
    .end annotation
    ...
    .line 1
    invoke-static {p0}, Landroidx/core/app/c0$b;->c(Ljava/lang/Object;)Landroidx/core/app/c0;
...
.method private static i(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 1
    invoke-static {p0}, Landroidx/core/app/c0$a;->a(Landroid/content/Intent;)Landroid/content/ClipData;
...
.method public static j(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0, p1}, Landroidx/core/app/c0$c;->c(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {p0}, Landroidx/core/app/c0;->i(Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static p(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    .line 2
    invoke-static {p0}, Landroidx/core/app/c0$b;->d(Landroid/content/Intent;)Landroid/os/Bundle;
...
.method public static q(Landroid/content/Intent;)I
    ...
    .line 2
    invoke-static {p0}, Landroidx/core/app/c0$d;->a(Landroid/content/Intent;)I
...
.method public static s(Landroid/content/Intent;I)V
    ...
    .line 2
    invoke-static {p0, p1}, Landroidx/core/app/c0$d;->b(Landroid/content/Intent;I)V
    ...
    invoke-static {p0, p1}, Landroidx/core/app/c0$a;->b(Landroid/content/Intent;Landroid/content/ClipData;)V
