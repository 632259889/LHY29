...
.method public static a(Landroid/view/Menu;ILandroidx/core/app/e0$b;)V
    .locals 1
    ...
    .param p1    # I
        ...
        .end annotation
    .end param
    .param p2    # Landroidx/core/app/e0$b;
        .annotation build Lk/f0;
        .end annotation
    .end param
    ...
    .line 2
    invoke-static {p0, p2}, Landroidx/core/app/e0;->b(Landroid/view/MenuItem;Landroidx/core/app/e0$b;)V
...
.method public static b(Landroid/view/MenuItem;Landroidx/core/app/e0$b;)V
    .locals 3
    .param p0    # Landroid/view/MenuItem;
        .annotation build Lk/f0;
        .end annotation
    .end param
    .param p1    # Landroidx/core/app/e0$b;
        .annotation build Lk/f0;
        .end annotation
    .end param
    .annotation runtime Ljava/lang/Deprecated;
    ...
    invoke-virtual {p1}, Landroidx/core/app/e0$b;->l()Landroid/content/Context;
    ...
    .line 8
    invoke-virtual {p1}, Landroidx/core/app/e0$b;->m()Landroid/content/Intent;
    ...
    .line 12
    invoke-virtual {p1}, Landroidx/core/app/e0$b;->j()Landroid/content/Intent;
...
.method public static c(Landroid/app/Activity;)Landroid/content/ComponentName;
    ...
    .line 3
    invoke-static {v0}, Landroidx/core/app/e0;->d(Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static e(Landroid/app/Activity;)Ljava/lang/String;
    ...
    .line 3
    invoke-static {v0}, Landroidx/core/app/e0;->f(Landroid/content/Intent;)Ljava/lang/String;
