...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/browser/trusted/t;->b:Ljava/util/Map;
    ...
    iput-object p1, p0, Landroidx/browser/trusted/t;->a:Landroid/content/Context;

    return-void
.end method

.method public static synthetic a(Landroidx/browser/trusted/t;Landroid/net/Uri;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/browser/trusted/t;->e(Landroid/net/Uri;)V

    return-void
.end method

.method public static c(Landroid/content/Context;)Landroidx/browser/trusted/t;
    .locals 1
    ...
    .line 1
    new-instance v0, Landroidx/browser/trusted/t;

    invoke-direct {v0, p0}, Landroidx/browser/trusted/t;-><init>(Landroid/content/Context;)V
...
.method private d(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    ...
    check-cast v5, Landroidx/browser/trusted/h;
    ...
    invoke-virtual {v5, v3, v6}, Landroidx/browser/trusted/h;->c(Ljava/lang/String;Landroid/content/pm/PackageManager;)Z
...
.method private synthetic e(Landroid/net/Uri;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/trusted/t;->b:Ljava/util/Map;
...
.method public b(Landroid/net/Uri;Ljava/util/Set;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroidx/browser/trusted/t;->a:Landroid/content/Context;

    const/4 v1, 0x1

    .line 4
    invoke-direct {p0, v0, p1, p2, v1}, Landroidx/browser/trusted/t;->d(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    ...
    new-instance v1, Landroidx/browser/trusted/s;

    invoke-direct {v1, p0, p1}, Landroidx/browser/trusted/s;-><init>(Landroidx/browser/trusted/t;Landroid/net/Uri;)V

    invoke-direct {v0, v1}, Landroidx/browser/trusted/b;-><init>(Ljava/lang/Runnable;)V

    .line 7
    iget-object v1, p0, Landroidx/browser/trusted/t;->b:Ljava/util/Map;

    invoke-interface {v1, p1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 8
    new-instance p1, Landroidx/browser/trusted/t$a;

    iget-object v1, p0, Landroidx/browser/trusted/t;->a:Landroid/content/Context;

    invoke-direct {p1, v1, p2, v0}, Landroidx/browser/trusted/t$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroidx/browser/trusted/b;)V
...
.method public f(Landroid/net/Uri;Ljava/util/Set;)Z
    ...
    invoke-direct {p0, v0, p1, p2, v2}, Landroidx/browser/trusted/t;->d(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
...
.method public g()V
    ...
    .line 2
    iget-object v2, p0, Landroidx/browser/trusted/t;->a:Landroid/content/Context;
