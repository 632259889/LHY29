...
.field private f:Lcom/android/billingclient/api/h$d$a;
...
.method private constructor <init>()V
    ...
    invoke-static {v0}, Lcom/android/billingclient/api/h$d$a;->f(Lcom/android/billingclient/api/h$d$a;)Lcom/android/billingclient/api/h$d$a;

    iput-object v0, p0, Lcom/android/billingclient/api/h$a;->f:Lcom/android/billingclient/api/h$d$a;
...
.method public synthetic constructor <init>(Lcom/android/billingclient/api/x0;)V
    ...
    invoke-static {p1}, Lcom/android/billingclient/api/h$d$a;->f(Lcom/android/billingclient/api/h$d$a;)Lcom/android/billingclient/api/h$d$a;

    iput-object p1, p0, Lcom/android/billingclient/api/h$a;->f:Lcom/android/billingclient/api/h$d$a;
...
.method public a()Lcom/android/billingclient/api/h;
    ...
    .line 33
    invoke-virtual {v8}, Lcom/android/billingclient/api/h$b;->b()Lcom/android/billingclient/api/r;
    ...
    .line 36
    invoke-virtual {v8}, Lcom/android/billingclient/api/r;->e()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Lcom/android/billingclient/api/r;->h()Ljava/lang/String;
    ...
    .line 44
    invoke-virtual {v9}, Lcom/android/billingclient/api/h$b;->b()Lcom/android/billingclient/api/r;
    ...
    invoke-virtual {v9}, Lcom/android/billingclient/api/r;->h()Ljava/lang/String;
    ...
    invoke-direct {v5, v4}, Lcom/android/billingclient/api/h;-><init>(Lcom/android/billingclient/api/c1;)V
    ...
    .line 52
    invoke-virtual {v0}, Lcom/android/billingclient/api/h$b;->b()Lcom/android/billingclient/api/r;

    move-result-object v0

    .line 53
    invoke-virtual {v0}, Lcom/android/billingclient/api/r;->h()Ljava/lang/String;
    ...
    :cond_16
    :goto_b
    invoke-static {v5, v1}, Lcom/android/billingclient/api/h;->h(Lcom/android/billingclient/api/h;Z)V

    iget-object v0, p0, Lcom/android/billingclient/api/h$a;->a:Ljava/lang/String;

    .line 55
    invoke-static {v5, v0}, Lcom/android/billingclient/api/h;->j(Lcom/android/billingclient/api/h;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/h$a;->f:Lcom/android/billingclient/api/h$d$a;

    .line 57
    invoke-virtual {v0}, Lcom/android/billingclient/api/h$d$a;->a()Lcom/android/billingclient/api/h$d;

    move-result-object v0

    invoke-static {v5, v0}, Lcom/android/billingclient/api/h;->n(Lcom/android/billingclient/api/h;Lcom/android/billingclient/api/h$d;)V
    ...
    :goto_c
    invoke-static {v5, v1}, Lcom/android/billingclient/api/h;->m(Lcom/android/billingclient/api/h;Ljava/util/ArrayList;)V

    iget-boolean v0, p0, Lcom/android/billingclient/api/h$a;->e:Z

    .line 61
    invoke-static {v5, v0}, Lcom/android/billingclient/api/h;->i(Lcom/android/billingclient/api/h;Z)V
    ...
    :goto_d
    invoke-static {v5, v0}, Lcom/android/billingclient/api/h;->l(Lcom/android/billingclient/api/h;Lcom/google/android/gms/internal/play_billing/zzu;)V
...
.method public b(Z)Lcom/android/billingclient/api/h$a;
    .locals 0
    .annotation build Lcom/android/billingclient/api/f2;
    .end annotation
...
.method public d(Ljava/lang/String;)Lcom/android/billingclient/api/h$a;
    .locals 0
    .param p1    # Ljava/lang/String;
        .annotation build Lk/f0;
        .end annotation
...
.method public e(Ljava/util/List;)Lcom/android/billingclient/api/h$a;
    .locals 1
...
.method public f(Lcom/android/billingclient/api/SkuDetails;)Lcom/android/billingclient/api/h$a;
    .locals 1
...
.method public g(Lcom/android/billingclient/api/h$d;)Lcom/android/billingclient/api/h$a;
    .locals 0
    .param p1    # Lcom/android/billingclient/api/h$d;
        .annotation build Lk/f0;
        .end annotation
    .end param
    .annotation build Lk/f0;
    ...
    .line 1
    invoke-static {p1}, Lcom/android/billingclient/api/h$d;->c(Lcom/android/billingclient/api/h$d;)Lcom/android/billingclient/api/h$d$a;
