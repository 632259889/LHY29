...
# static fields
.field private static final a:Ljava/lang/String; = "BlurHelper"

.field private static b:J

.field private static volatile c:Landroid/renderscript/RenderScript;
...
.method public static synthetic a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lrazerdp/blur/a;->m(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/graphics/Bitmap;IIF)Landroid/graphics/Bitmap;
    ...
    sput-wide v0, Lrazerdp/blur/a;->b:J
    ...
    .line 3
    invoke-static {v3, v0}, Lrazerdp/util/log/PopupLog;->i(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 4
    invoke-static {p0, p1, p2, p3, p4}, Lrazerdp/blur/a;->l(Landroid/content/Context;Landroid/graphics/Bitmap;IIF)Landroid/graphics/Bitmap;
    ...
    .line 6
    invoke-static {p0, p1, p2, p3, p4}, Lrazerdp/blur/a;->f(Landroid/content/Context;Landroid/graphics/Bitmap;IIF)Landroid/graphics/Bitmap;
...
.method public static c(Landroid/content/Context;Landroid/view/View;FF)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x1

    .line 1
    invoke-static {p0, p1, p2, p3, v0}, Lrazerdp/blur/a;->d(Landroid/content/Context;Landroid/view/View;FFZ)Landroid/graphics/Bitmap;
...
.method public static d(Landroid/content/Context;Landroid/view/View;FFZ)Landroid/graphics/Bitmap;
    .locals 7
...
.method public static e(Landroid/content/Context;Landroid/view/View;FFZII)Landroid/graphics/Bitmap;
    .locals 0

    .line 1
    invoke-static {p1, p2, p4, p5, p6}, Lrazerdp/blur/a;->h(Landroid/view/View;FZII)Landroid/graphics/Bitmap;
...
.method public static f(Landroid/content/Context;Landroid/graphics/Bitmap;IIF)Landroid/graphics/Bitmap;
    .locals 4
    ...
    .line 2
    invoke-static {p4, v1, v2}, Lrazerdp/blur/a;->j(FFF)F
    ...
    invoke-static {p1, p4, v1}, Lrazerdp/blur/c;->a(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    ...
    sget-wide v2, Lrazerdp/blur/a;->b:J
    ...
    invoke-static {p0, v0}, Lrazerdp/blur/a;->m(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p2, p0}, Lrazerdp/util/log/PopupLog;->i(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static g(Landroid/content/Context;)Landroid/renderscript/RenderScript;
    .locals 2

    .line 1
    sget-object v0, Lrazerdp/blur/a;->c:Landroid/renderscript/RenderScript;
    ...
    .line 3
    :try_start_0
    sget-object v1, Lrazerdp/blur/a;->c:Landroid/renderscript/RenderScript;
    ...
    sput-object p0, Lrazerdp/blur/a;->c:Landroid/renderscript/RenderScript;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lrazerdp/blur/a;->c:Landroid/renderscript/RenderScript;

    return-object p0
.end method

.method public static h(Landroid/view/View;FZII)Landroid/graphics/Bitmap;
    .locals 19
    ...
    invoke-static {v7}, Lrazerdp/util/log/PopupLog;->h(Ljava/lang/Object;)V
...
.method public static i(Landroid/view/View;Z)Landroid/graphics/Bitmap;
    .locals 2
    ...
    .line 1
    invoke-static {p0, v0, p1, v1, v1}, Lrazerdp/blur/a;->h(Landroid/view/View;FZII)Landroid/graphics/Bitmap;
...
.method public static l(Landroid/content/Context;Landroid/graphics/Bitmap;IIF)Landroid/graphics/Bitmap;
    .locals 8
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lrazerdp/blur/a;->g(Landroid/content/Context;)Landroid/renderscript/RenderScript;
    ...
    .line 8
    invoke-static {v4, v0}, Lrazerdp/util/log/PopupLog;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 12
    invoke-static {p4, v6, v7}, Lrazerdp/blur/a;->j(FFF)F
    ...
    invoke-static {v4, p0}, Lrazerdp/util/log/PopupLog;->i(Ljava/lang/String;[Ljava/lang/Object;)V
