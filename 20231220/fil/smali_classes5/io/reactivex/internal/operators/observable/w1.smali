...
.method public constructor <init>(Lio/reactivex/e0;I)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/w1;->b:Lio/reactivex/e0;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/w1;->c:Ljava/util/concurrent/Callable;
...
.method public constructor <init>(Lio/reactivex/e0;Ljava/util/concurrent/Callable;)V
    ...
    .line 6
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/w1;->c:Ljava/util/concurrent/Callable;
...
.method public b()Lio/reactivex/z;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/w1;->b:Lio/reactivex/e0;

    iget-object v2, p0, Lio/reactivex/internal/operators/observable/w1;->c:Ljava/util/concurrent/Callable;

    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/observable/v1;-><init>(Lio/reactivex/e0;Ljava/util/concurrent/Callable;)V
...
.method public b1(Lio/reactivex/l0;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/w1;->c:Ljava/util/concurrent/Callable;
    ...
    invoke-direct {v2, p1, v0}, Lio/reactivex/internal/operators/observable/w1$a;-><init>(Lio/reactivex/l0;Ljava/util/Collection;)V
