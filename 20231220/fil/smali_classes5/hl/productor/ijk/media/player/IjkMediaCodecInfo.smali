.class public Lhl/productor/ijk/media/player/IjkMediaCodecInfo;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->mRank:I
...
.method private static declared-synchronized getKnownCodecList()Ljava/util/Map;
    ...
    const-class v0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;

    monitor-enter v0

    .line 1
    :try_start_0
    sget-object v1, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
    :try_end_0
    ...
    sput-object v1, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
...
.method public static getProfileLevelName(II)Ljava/lang/String;
    ...
    .line 2
    invoke-static {p0}, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->getProfileName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->getLevelName(I)Ljava/lang/String;
...
.method public static setupCandidate(Landroid/media/MediaCodecInfo;Ljava/lang/String;)Lhl/productor/ijk/media/player/IjkMediaCodecInfo;
    .locals 6
    ...
    .line 13
    :cond_a
    invoke-static {}, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->getKnownCodecList()Ljava/util/Map;
    ...
    :cond_c
    :goto_2
    new-instance v0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;

    invoke-direct {v0}, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;-><init>()V

    .line 17
    iput-object p0, v0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;

    .line 18
    iput v3, v0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->mRank:I

    .line 19
    iput-object p1, v0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->mMimeType:Ljava/lang/String;
...
.method public dumpProfileLevels(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;
    ...
    .line 9
    invoke-static {v3, v4}, Lhl/productor/ijk/media/player/IjkMediaCodecInfo;->getProfileLevelName(II)Ljava/lang/String;
